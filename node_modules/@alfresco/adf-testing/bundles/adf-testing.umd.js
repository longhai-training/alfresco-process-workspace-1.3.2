(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@alfresco/js-api'), require('@alfresco/adf-core'), require('protractor'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@alfresco/adf-testing', ['exports', '@alfresco/js-api', '@alfresco/adf-core', 'protractor', '@angular/core'], factory) :
    (factory((global.alfresco = global.alfresco || {}, global.alfresco['adf-testing'] = {}),global.jsApi,global.adfCore,global.protractor,global.ng.core));
}(this, (function (exports,jsApi,adfCore,protractor,i0) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var GroupIdentityService = /** @class */ (function () {
         ...
         */
            function (groupName) {
                if (groupName === void 0) {
                    groupName = StringUtil.generateRandomString(5);
                }
                return __awaiter(this, void 0, void 0, function () {
                    var group;
                    return __generator(this, function (_a) {
    ...
    var ApiService = /** @class */ (function () {
        function ApiService(clientId, host, hostSso, provider) {
            ...
            this.apiService = new jsApi.AlfrescoApiCompatibility(this.config);
        }
        /**
         * @param {?} username
         * @param {?} password
     ...
     */
    /** @type {?} */
    var until = protractor.protractor.ExpectedConditions;
    /** @type {?} */
    ...
    var BrowserVisibility = /** @class */ (function () {
        ...
        BrowserVisibility.waitUntilElementIsVisible = /*
            ...
            function (elementToCheck, waitTimeout) {
                ...
                return protractor.browser.wait(( /**
                 * @return {?}
                 */function () {
       ...
       */
        ...
        BrowserVisibility.waitUntilElementIsStale = /*
           ...
           */
            ...
            function (elementToCheck, waitTimeout) {
                ...
                return protractor.browser.wait(until.stalenessOf(elementToCheck), waitTimeout, 'Element is not in stale ' + elementToCheck.locator());
            };
        /*
         * Wait for element to not be visible
         */
        ...
        BrowserVisibility.waitUntilElementHasValue = /*
            ...
            function (elementToCheck, elementValue, waitTimeout) {
                ...
                protractor.browser.waitForAngularEnabled();
                protractor.browser.wait(until.textToBePresentInElementValue(elementToCheck, elementValue), waitTimeout, 'Element doesn\'t have a value ' + elementToCheck.locator());
            };
        /**
         * @param {?} elementToCheck
         * @param {?=} waitTimeout
         ...
         */
            function (elementToCheck, waitTimeout) {
                ...
                return protractor.browser.wait(protractor.browser.wait(until.visibilityOf(elementToCheck)), waitTimeout);
            };
        /*
         * Wait for element to not be visible
         */
        ...
        BrowserVisibility.waitUntilElementIsNotOnPage = /*
            ...
            function (elementToCheck, waitTimeout) {
                ...
                return protractor.browser.wait(until.not(until.visibilityOf(elementToCheck)), waitTimeout, 'Element is not in the page ' + elementToCheck.locator());
            };
        /**
         * @param {?} elementToCheck
         * @param {?=} waitTimeout
         ...
         */
            function (elementToCheck, waitTimeout) {
                ...
                protractor.browser.waitForAngularEnabled();
                return protractor.browser.wait(until.presenceOf(elementToCheck), waitTimeout, 'Element is not present ' + elementToCheck.locator());
            };
        /**
         * @param {?} elementToCheck
         * @param {?=} waitTimeout
         ...
         */
            function (elementToCheck, waitTimeout) {
                ...
                return protractor.browser.wait(until.not(until.presenceOf(elementToCheck)), waitTimeout, 'Element is not in the page ' + elementToCheck.locator());
            };
    ...
    var HeaderPage = /** @class */ (function () {
        function HeaderPage() {
            this.checkBox = protractor.element(protractor.by.cssContainingText('.mat-checkbox-label', 'Show menu button'));
            this.headerColor = protractor.element(protractor.by.css('option[value="primary"]'));
            this.titleInput = protractor.element(protractor.by.css('input[name="title"]'));
            this.iconInput = protractor.element(protractor.by.css('input[placeholder="URL path"]'));
            this.hexColorInput = protractor.element(protractor.by.css('input[placeholder="hex color code"]'));
            this.logoHyperlinkInput = protractor.element(protractor.by.css('input[placeholder="Redirect URL"]'));
            this.logoTooltipInput = protractor.element(protractor.by.css('input[placeholder="Tooltip text"]'));
            this.positionStart = protractor.element.all(protractor.by.css('mat-radio-button[value="start"]')).first();
            this.positionEnd = protractor.element.all(protractor.by.css('mat-radio-button[value="end"]')).first();
            this.sideBarPositionRight = protractor.element(protractor.by.css('mat-sidenav.mat-drawer.mat-sidenav.mat-drawer-end'));
            this.sideBarPositionLeft = protractor.element(protractor.by.css('mat-sidenav.mat-drawer.mat-sidenav'));
        }
        /**
         * @return {?}
         */
         ...
         */
            function () {
                /** @type {?} */
                var checkBox = protractor.element.all(protractor.by.css('mat-checkbox'));
         ...
         */
            function (color) {
                /** @type {?} */
                var headerColor = protractor.element(protractor.by.css('option[value="' + color + '"]'));
         ...
         */
            function (name) {
                /** @type {?} */
                var title = protractor.element(protractor.by.cssContainingText('.adf-app-title', name));
         ...
         */
            function (title) {
                ...
                this.titleInput.sendKeys(protractor.protractor.Key.ENTER);
            };
        /**
         * @param {?} url
         * @return {?}
         ...
         */
            function (url) {
                /** @type {?} */
                var icon = protractor.element(protractor.by.css('img[src="' + url + '"]'));
         ...
         */
            function (url) {
                ...
                this.iconInput.sendKeys(protractor.protractor.Key.ENTER);
            };
        /**
         * @return {?}
         */
         ...
         */
            function (hexCode) {
                ...
                return this.hexColorInput.sendKeys(protractor.protractor.Key.ENTER);
            };
        /**
         * @param {?} hyperlink
         * @return {?}
         ...
         */
            function (hyperlink) {
                ...
                return this.logoHyperlinkInput.sendKeys(protractor.protractor.Key.ENTER);
            };
        /**
         * @param {?} tooltip
         * @return {?}
         ...
         */
            function (tooltip) {
                ...
                return this.logoTooltipInput.sendKeys(protractor.protractor.Key.ENTER);
            };
        /**
         * @return {?}
         */
    ...
    var TabsPage = /** @class */ (function () {
         ...
         */
            function (tabTitle) {
                /** @type {?} */
                var tab = protractor.element(protractor.by.cssContainingText("div[id*='mat-tab-label']", tabTitle));
    ...
    var UserInfoPage = /** @class */ (function () {
        function UserInfoPage() {
            this.dialog = protractor.element.all(protractor.by.css('mat-card[class*="adf-userinfo-card"]')).first();
            this.userImage = protractor.element(protractor.by.css('div[id="user-initial-image"]'));
            this.userInfoEcmHeaderTitle = protractor.element(protractor.by.css('div[id="ecm-username"]'));
            this.userInfoEcmTitle = protractor.element(protractor.by.css('mat-card-content span[id="ecm-full-name"]'));
            this.ecmEmail = protractor.element(protractor.by.css('span[id="ecm-email"]'));
            this.ecmJobTitle = protractor.element(protractor.by.css('span[id="ecm-job-title"]'));
            this.userInfoProcessHeaderTitle = protractor.element(protractor.by.css('div[id="bpm-username"]'));
            this.userInfoProcessTitle = protractor.element(protractor.by.css('mat-card-content span[id="bpm-full-name"]'));
            this.processEmail = protractor.element(protractor.by.css('span[id="bpm-email"]'));
            this.processTenant = protractor.element(protractor.by.css('span[class="detail-profile"]'));
            this.apsImage = protractor.element(protractor.by.css('img[id="bpm-user-detail-image"]'));
            this.acsImage = protractor.element(protractor.by.css('img[id="ecm-user-detail-image"]'));
            this.initialImage = protractor.element.all(protractor.by.css('div[id="user-initials-image"]')).first();
            this.userInfoSsoHeaderTitle = this.dialog.element(protractor.by.css('div[id="identity-username"]'));
            this.userInfoSsoTitle = protractor.element(protractor.by.css('.adf-userinfo__detail-title'));
            this.ssoEmail = protractor.element(protractor.by.id('identity-email'));
            this.userProfileButton = protractor.element(protractor.by.css('button[data-automation-id="adf-user-profile"]'));
        }
        /**
         * @template THIS
         * @this {THIS}
         ...
         */
            function () {
                BrowserVisibility.waitUntilElementIsVisible(this.dialog);
                protractor.browser.actions().sendKeys(protractor.protractor.Key.ESCAPE).perform();
            };
        /**
         * @return {?}
         */
            ...
            function (toggle) {
                 ...
                 */function (check) {
                    if (check.indexOf('mat-checked') < 0) {
                        BrowserVisibility.waitUntilElementIsClickable(toggle.all(protractor.by.css('div')).first());
                        toggle.all(protractor.by.css('div')).first().click();
                    }
                }));
            };
        /**
         ...
         */
            function (field, value) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, protractor.browser.executeScript('window.adf.setConfigField(`' + field + '`, `' + value + '`);')];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
         ...
         */
            function (field, value) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, protractor.browser.executeScript('window.adf.setStorageItem(`' + field + '`, `' + value + '`);')];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
         ...
         */
            function () {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, protractor.browser.executeScript('window.adf.clearStorage();')];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
         ...
         */
            function () {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, protractor.browser.executeScript("window.adf.apiReset();")];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
    ...
    var LoginPage = /** @class */ (function () {
        function LoginPage() {
            this.loginURL = protractor.browser.baseUrl + '/login';
            this.formControllersPage = new FormControllersPage();
            this.txtUsername = protractor.element(protractor.by.css('input[id="username"]'));
            this.txtPassword = protractor.element(protractor.by.css('input[id="password"]'));
            this.logoImg = protractor.element(protractor.by.css('img[id="adf-login-img-logo"]'));
            this.successRouteTxt = protractor.element(protractor.by.css('input[data-automation-id="adf-success-route"]'));
            this.logoTxt = protractor.element(protractor.by.css('input[data-automation-id="adf-url-logo"]'));
            this.usernameTooltip = protractor.element(protractor.by.css('span[data-automation-id="username-error"]'));
            this.passwordTooltip = protractor.element(protractor.by.css('span[data-automation-id="password-required"]'));
            this.loginTooltip = protractor.element(protractor.by.css('span[class="adf-login-error-message"]'));
            this.usernameInactive = protractor.element(protractor.by.css('input[id="username"][aria-invalid="false"]'));
            this.passwordInactive = protractor.element(protractor.by.css('input[id="password"][aria-invalid="false"]'));
            this.adfLogo = protractor.element(protractor.by.css('img[class="adf-img-logo ng-star-inserted"]'));
            this.usernameHighlighted = protractor.element(protractor.by.css('input[id="username"][aria-invalid="true"]'));
            this.passwordHighlighted = protractor.element(protractor.by.css('input[id="password"][aria-invalid="true"]'));
            this.signInButton = protractor.element(protractor.by.id('login-button'));
            this.showPasswordElement = protractor.element(protractor.by.css('mat-icon[data-automation-id="show_password"]'));
            this.hidePasswordElement = protractor.element(protractor.by.css('mat-icon[data-automation-id="hide_password"]'));
            this.rememberMe = protractor.element(protractor.by.css('mat-checkbox[id="adf-login-remember"]'));
            this.needHelp = protractor.element(protractor.by.css('div[id="adf-login-action-left"]'));
            this.register = protractor.element(protractor.by.css('div[id="adf-login-action-right"]'));
            this.footerSwitch = protractor.element(protractor.by.id('switch4'));
            this.rememberMeSwitch = protractor.element(protractor.by.id('adf-toggle-show-rememberme'));
            this.successRouteSwitch = protractor.element(protractor.by.id('adf-toggle-show-successRoute'));
            this.logoSwitch = protractor.element(protractor.by.id('adf-toggle-logo'));
            this.header = protractor.element(protractor.by.id('adf-header'));
            this.settingsIcon = protractor.element(protractor.by.cssContainingText('a[data-automation-id="settings"] mat-icon', 'settings'));
        }
        /**
         * @template THIS
         * @this {THIS}
         ...
         */
            function () {
                ...
                protractor.browser.driver.get(( /** @type {?} */(this)).loginURL);
            ...
            function () {
                 ...
                 */function (value) {
                    for (var i = value.length; i >= 0; i--) {
                        ( /** @type {?} */(_this)).txtUsername.sendKeys(protractor.protractor.Key.BACK_SPACE);
                    }
                }));
                return ( /** @type {?} */(this));
            };
         ...
         */
            function () {
                 ...
                 */function (value) {
                    for (var i = value.length; i >= 0; i--) {
                        _this.txtPassword.sendKeys(protractor.protractor.Key.BACK_SPACE);
                    }
                }));
            };
        /**
    ...
    var SettingsPage = /** @class */ (function () {
        function SettingsPage() {
            this.settingsURL = protractor.browser.baseUrl + '/settings';
            this.providerDropdown = protractor.element(protractor.by.css('mat-select[id="adf-provider-selector"] div[class="mat-select-arrow-wrapper"]'));
            this.ecmAndBpm = {
                option: protractor.element(protractor.by.xpath('//SPAN[@class="mat-option-text"][contains(text(),"ALL")]')),
                text: 'ALL'
            };
            this.bpm = {
                option: protractor.element(protractor.by.xpath('//SPAN[@class="mat-option-text"][contains(text(),"BPM") and not (contains(text(),"and"))]')),
                text: 'BPM'
            };
            this.ecm = {
                option: protractor.element(protractor.by.xpath('//SPAN[@class="mat-option-text"][contains(text(),"ECM") and not (contains(text(),"and"))]')),
                text: 'ECM'
            };
            this.oauth = {
                option: protractor.element(protractor.by.xpath('//SPAN[@class="mat-option-text"][contains(text(),"OAUTH")]')),
                text: 'OAUTH'
            };
            this.selectedOption = protractor.element(protractor.by.css('span[class*="mat-select-value-text"]'));
            this.ecmText = protractor.element(protractor.by.css('input[data-automation-id*="ecmHost"]'));
            this.bpmText = protractor.element(protractor.by.css('input[data-automation-id*="bpmHost"]'));
            this.clientIdText = protractor.element(protractor.by.css('input[id="clientId"]'));
            this.authHostText = protractor.element(protractor.by.css('input[id="oauthHost"]'));
            this.logoutUrlText = protractor.element(protractor.by.css('input[id="logout-url"]'));
            this.basicAuthRadioButton = protractor.element(protractor.by.cssContainingText('mat-radio-button[id*="mat-radio"]', 'Basic Authentication'));
            this.identityHostText = protractor.element(protractor.by.css('input[id="identityHost"]'));
            this.ssoRadioButton = protractor.element(protractor.by.cssContainingText('[id*="mat-radio"]', 'SSO'));
            this.silentLoginToggleLabel = protractor.element(protractor.by.css('mat-slide-toggle[name="silentLogin"] label'));
            this.silentLoginToggleElement = protractor.element(protractor.by.css('mat-slide-toggle[name="silentLogin"]'));
            this.implicitFlowLabel = protractor.element(protractor.by.css('mat-slide-toggle[name="implicitFlow"] label'));
            this.implicitFlowElement = protractor.element(protractor.by.css('mat-slide-toggle[name="implicitFlow"]'));
            this.applyButton = protractor.element(protractor.by.css('button[data-automation-id*="host-button"]'));
            this.backButton = protractor.element(protractor.by.cssContainingText('button span[class="mat-button-wrapper"]', 'Back'));
            this.validationMessage = protractor.element(protractor.by.cssContainingText('mat-error', 'This field is required'));
        }
        /**
         * @template THIS
         * @this {THIS}
         ...
         */
            function () {
                protractor.browser.waitForAngularEnabled(true);
                protractor.browser.driver.get(( /** @type {?} */(this)).settingsURL);
         ...
         */
            function (contentServiceURL, authHost, identityHost, silentLogin, implicitFlow, clientId, logoutUr) {
                if (silentLogin === void 0) {
                    silentLogin = true;
                }
                if (implicitFlow === void 0) {
                    implicitFlow = true;
                }
                if (logoutUr === void 0) {
                    logoutUr = '/logout';
         ...
         */
            function (clientId) {
                if (clientId === void 0) {
                    clientId = protractor.browser.params.config.oauth2.clientId;
                }
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
         ...
         */
            function () {
                ...
                this.ecmText.sendKeys(protractor.protractor.Key.BACK_SPACE);
            };
        /**
         * @return {?}
         */
         ...
         */
            function () {
                ...
                this.bpmText.sendKeys(protractor.protractor.Key.BACK_SPACE);
            };
        /**
         * @param {?} authHostURL
         * @return {?}
    ...
    var LoginSSOPage = /** @class */ (function () {
        function LoginSSOPage() {
            this.ssoButton = protractor.element(protractor.by.css("[data-automation-id=\"login-button-sso\"]"));
            this.usernameField = protractor.element(protractor.by.id('username'));
            this.passwordField = protractor.element(protractor.by.id('password'));
            this.loginButton = protractor.element(protractor.by.css('input[class="submit"]'));
            this.header = protractor.element(protractor.by.id('adf-header'));
            this.loginError = protractor.element(protractor.by.css("div[data-automation-id=\"login-error\"]"));
        }
        /**
         * @param {?} username
         * @param {?} password
         ...
         */
            function (username, password) {
                ...
                protractor.browser.actions().sendKeys(protractor.protractor.Key.ENTER).perform();
                return BrowserVisibility.waitUntilElementIsVisible(this.header);
            };
        /**
         * @return {?}
    ...
    var DataTableComponentPage = /** @class */ (function () {
        function DataTableComponentPage(rootElement) {
            if (rootElement === void 0) {
                rootElement = protractor.element.all(protractor.by.css('adf-datatable')).first();
            }
            this.rows = protractor.by.css("adf-datatable div[class*='adf-datatable-body'] div[class*='adf-datatable-row']");
            this.rootElement = rootElement;
            this.list = this.rootElement.all(protractor.by.css("div[class*='adf-datatable-body'] div[class*='adf-datatable-row']"));
            this.contents = this.rootElement.all(protractor.by.css('div[class="adf-datatable-body"] span'));
            this.tableBody = this.rootElement.all(protractor.by.css("div[class='adf-datatable-body']")).first();
            this.spinner = this.rootElement.element(protractor.by.css('mat-progress-spinner'));
            this.allColumns = this.rootElement.all(protractor.by.css('div[data-automation-id*="auto_id_entry."]'));
            this.selectedRowNumber = this.rootElement.element(protractor.by.css("div[class*='is-selected'] div[data-automation-id*='text_']"));
            this.allSelectedRows = this.rootElement.all(protractor.by.css("div[class*='is-selected']"));
            this.selectAll = this.rootElement.element(protractor.by.css("div[class*='adf-datatable-header'] mat-checkbox"));
            this.copyColumnTooltip = this.rootElement.element(protractor.by.css("adf-copy-content-tooltip span"));
        }
        /**
         * @template THIS
         * @this {THIS}
         ...
         */
            function () {
                 ...
                 */function () {
                    ...
                    BrowserVisibility.waitUntilElementIsVisible(( /** @type {?} */(_this)).selectAll.element(protractor.by.css('input[aria-checked="true"]')));
                }));
                return ( /** @type {?} */(this));
            };
        /**
         ...
         */
            function () {
                 ...
                 */function () {
                    ( /** @type {?} */(_this)).selectAll.click();
                    BrowserVisibility.waitUntilElementIsNotOnPage(( /** @type {?} */(_this)).selectAll.element(protractor.by.css('input[aria-checked="true"]')));
                }));
                return ( /** @type {?} */(this));
            };
        /**
         ...
         */
            function (columnName, columnValue) {
                BrowserVisibility.waitUntilElementIsNotOnPage(this.getRowCheckbox(columnName, columnValue).element(protractor.by.css('input[aria-checked="true"]')));
            };
        /**
         * @param {?} columnName
         * @param {?} columnValue
         ...
         */
            function (columnName, columnValue) {
                ...
                BrowserVisibility.waitUntilElementIsVisible(rowCheckbox.element(protractor.by.css('input[aria-checked="true"]')));
            };
        /**
         * @param {?} columnName
         * @param {?} columnValue
         ...
         */
            function (columnName, columnValue) {
                return this.getRow(columnName, columnValue)
                    .element(protractor.by.css('mat-checkbox'));
            };
        /**
         * @return {?}
         */
         ...
         */
            function (columnName, columnValue) {
                ...
                protractor.browser.actions().sendKeys(protractor.protractor.Key.COMMAND).click(row).perform();
            };
        /**
         * @template THIS
         * @this {THIS}
         ...
         */
            function (columnName, columnValue) {
                /** @type {?} */
                var selectedRow = ( /** @type {?} */(this)).getCellElementByValue(columnName, columnValue).element(protractor.by.xpath("ancestor::div[contains(@class, 'is-selected')]"));
         ...
         */
            function (identifyingColumn, identifyingValue, columnName) {
                ...
                BrowserVisibility.waitUntilElementIsVisible(row);
                /** @type {?} */
                var rowColumn = row.element(protractor.by.css("div[title=\"" + columnName + "\"] span"));
         ...
         */
            function (sortOrder, locator) {
                /** @type {?} */
                var deferred = protractor.protractor.promise.defer();
                /** @type {?} */
                var column = protractor.element.all(protractor.by.css("div[title='" + locator + "'] span"));
         ...
         */
            function (columnName, columnValue) {
                /** @type {?} */
                var row = this.getRow(columnName, columnValue);
                protractor.browser.actions().click(row, protractor.protractor.Button.RIGHT).perform();
                BrowserVisibility.waitUntilElementIsVisible(protractor.element(protractor.by.id('adf-context-menu-content')));
            };
        /**
         * @param {?} columnName
         * @param {?} columnValue
         ...
         */
            function (filename) {
                return protractor.element(protractor.by.cssContainingText('adf-name-column[class*="adf-datatable-link"] span', filename));
            };
        /**
         * @return {?}
         */
            ...
            function (column) {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                columnLocator = protractor.by.css("adf-datatable div[class*='adf-datatable-body'] div[class*='adf-datatable-row'] div[title='" + column + "'] span");
                                BrowserVisibility.waitUntilElementIsVisible(protractor.element.all(columnLocator).first());
                                return [4 /*yield*/, protractor.element.all(columnLocator).getText()];
                            case 1:
                                initialList = _a.sent();
         ...
         */
            function (columnName, columnValue) {
                return __awaiter(this, void 0, void 0, function () {
                    var columnLocator;
                    return __generator(this, function (_a) {
                        columnLocator = protractor.by.css("div[title='" + columnName + "'] div[data-automation-id=\"text_" + columnValue + "\"] span");
         ...
         */
            function (detail) {
                /** @type {?} */
                var firstNode = protractor.element.all(protractor.by.css("adf-datatable div[title=\"" + detail + "\"] span")).first();
         ...
         */
            function (detail) {
                return protractor.element.all(protractor.by.css("adf-datatable div[title=\"" + detail + "\"] span"));
            };
        /**
         * @param {?} sortOrder
         * @param {?} column
         ...
         */
            function (sortOrder, column) {
                /** @type {?} */
                var locator = protractor.by.css("div[data-automation-id=\"auto_id_" + column + "\"]");
                BrowserVisibility.waitUntilElementIsVisible(protractor.element(locator));
                return protractor.element(locator).getAttribute('class').then(( /**
                 * @param {?} result
                 * @return {?}
                 */function (result) {
                    if (sortOrder === true) {
                        if (!result.includes('sorted-asc')) {
                            if (result.includes('sorted-desc') || result.includes('sortable')) {
                                protractor.element(locator).click();
                            }
                        }
                    }
                    else {
         ...
         */
            function (columnName, columnValue) {
                /** @type {?} */
                var row = this.rootElement.all(protractor.by.css("div[title=\"" + columnName + "\"] div[data-automation-id=\"text_" + columnValue + "\"]")).first()
                    .element(protractor.by.xpath("ancestor::div[contains(@class, 'adf-datatable-row')]"));
                BrowserVisibility.waitUntilElementIsVisible(row);
                return row;
            };
        /**
         ...
         */
            function (columnName, columnValue) {
                return this.rootElement.all(protractor.by.css("div[title=\"" + columnName + "\"] div[data-automation-id=\"text_" + columnValue + "\"] span")).first();
            };
        /**
         * @template THIS
         * @this {THIS}
         ...
         */
            function (column) {
                BrowserVisibility.waitUntilElementIsVisible(protractor.element(protractor.by.css("div[data-automation-id=\"auto_id_entry." + column + "\"]")));
                return ( /** @type {?} */(this));
            };
        /**
         * @return {?}
         ...
         */
            function (rowNumber, columnName) {
                return this.list.get(rowNumber).element(protractor.by.css("div[title=\"" + columnName + "\"] span"));
            };
        /**
         * @param {?} rowColumn
         * @param {?} rowContent
         ...
         */
            function (rowColumn, rowContent, columnName) {
                return this.getRow(rowColumn, rowContent).element(protractor.by.css("div[title='" + columnName + "']"));
            };
        /**
         * @param {?} content
         * @return {?}
         ...
         */
            function (folderName) {
                /** @type {?} */
                var selectedRow = ( /** @type {?} */(this)).getCellByContent(folderName).element(protractor.by.xpath("ancestor::div[contains(@class, 'is-selected')]"));
                BrowserVisibility.waitUntilElementIsVisible(selectedRow);
                return ( /** @type {?} */(this));
            };
        /**
         ...
         */
            function (content) {
                /** @type {?} */
                var cell = this.rootElement.element(protractor.by.cssContainingText("div[class*='adf-datatable-row'] div[class*='adf-name-location-cell-name']", content));
         ...
         */
            function (name) {
                /** @type {?} */
                var resultElement = this.rootElement.all(protractor.by.css("div[data-automation-id='" + name + "']")).first();
         ...
         */
            function (elem) {
                ...
                protractor.browser.actions().mouseMove(elem).perform();
                return ( /** @type {?} */(this));
            };
        /**
         * @template THIS
    ...
    var PaginationPage = /** @class */ (function () {
        function PaginationPage() {
            this.itemsPerPageDropdown = protractor.element(protractor.by.css('div[class*="adf-pagination__perpage-block"] button'));
            this.pageSelectorDropDown = protractor.element(protractor.by.css('div[class*="adf-pagination__page-selector"]'));
            this.pageSelectorArrow = protractor.element(protractor.by.css('button[data-automation-id="page-selector"]'));
            this.itemsPerPage = protractor.element(protractor.by.css('span[class="adf-pagination__max-items"]'));
            this.currentPage = protractor.element(protractor.by.css('span[class="adf-pagination__current-page"]'));
            this.totalPages = protractor.element(protractor.by.css('span[class="adf-pagination__total-pages"]'));
            this.paginationRange = protractor.element(protractor.by.css('span[class="adf-pagination__range"]'));
            this.nextPageButton = protractor.element(protractor.by.css('button[class*="adf-pagination__next-button"]'));
            this.nextButtonDisabled = protractor.element(protractor.by.css('button[class*="adf-pagination__next-button"][disabled]'));
            this.previousButtonDisabled = protractor.element(protractor.by.css('button[class*="adf-pagination__previous-button"][disabled]'));
            this.pageDropDown = protractor.element(protractor.by.css('div[class*="adf-pagination__actualinfo-block"] button'));
            this.pageDropDownOptions = protractor.by.css('div[class*="mat-menu-content"] button');
            this.paginationSection = protractor.element(protractor.by.css('adf-pagination'));
            this.paginationSectionEmpty = protractor.element(protractor.by.css('adf-pagination[class*="adf-pagination__empty"]'));
            this.totalFiles = protractor.element(protractor.by.css('span[class="adf-pagination__range"]'));
        }
        /**
         * @template THIS
         * @this {THIS}
         ...
         */
            function (numberOfItem) {
                ...
                protractor.browser.actions().mouseMove(( /** @type {?} */(this)).itemsPerPageDropdown).perform();
                BrowserVisibility.waitUntilElementIsVisible(( /** @type {?} */(this)).itemsPerPageDropdown);
                BrowserVisibility.waitUntilElementIsClickable(( /** @type {?} */(this)).itemsPerPageDropdown);
                ( /** @type {?} */(this)).itemsPerPageDropdown.click();
                BrowserVisibility.waitUntilElementIsVisible(( /** @type {?} */(this)).pageSelectorDropDown);
                /** @type {?} */
                var itemsPerPage = protractor.element.all(protractor.by.cssContainingText('.mat-menu-item', numberOfItem)).first();
         ...
         */
            function () {
                ...
                protractor.browser.actions().mouseMove(this.nextPageButton).perform();
                BrowserVisibility.waitUntilElementIsVisible(this.nextPageButton);
                BrowserVisibility.waitUntilElementIsClickable(this.nextPageButton);
         ...
         */
            function (numberOfItemPerPage) {
                BrowserVisibility.waitUntilElementIsVisible(protractor.element.all(( /** @type {?} */(this)).pageDropDownOptions).first());
                /** @type {?} */
                var option = protractor.element(protractor.by.cssContainingText('div[class*="mat-menu-content"] button', numberOfItemPerPage));
                BrowserVisibility.waitUntilElementIsVisible(option);
                option.click();
                return ( /** @type {?} */(this));
            };
         ...
         */
            function () {
                /** @type {?} */
                var deferred = protractor.protractor.promise.defer();
                BrowserVisibility.waitUntilElementIsVisible(protractor.element.all(this.pageDropDownOptions).first());
                /** @type {?} */
                var initialList = [];
                protractor.element.all(this.pageDropDownOptions).each(( /**
                 * @param {?} currentOption
                 * @return {?}
    ...
    var ErrorPage = /** @class */ (function () {
        function ErrorPage() {
            this.errorPageCode = protractor.element(protractor.by.css('adf-error-content .adf-error-content-code'));
            this.errorPageTitle = protractor.element(protractor.by.css('adf-error-content .adf-error-content-title'));
            this.errorPageDescription = protractor.element(protractor.by.css('adf-error-content .adf-error-content-description'));
            this.backButton = protractor.element(protractor.by.id('adf-return-button'));
            this.secondButton = protractor.element(protractor.by.id('adf-secondary-button'));
        }
        /**
         * @return {?}
         */
    ...
    function byCss(literals) {
        ...
        return protractor.browser.element(protractor.by.css(selector));
    }
    ...
    var DocumentListPage = /** @class */ (function () {
        function DocumentListPage(rootElement) {
            if (rootElement === void 0) {
                rootElement = protractor.element.all(protractor.by.css('adf-document-list')).first();
            }
            this.actionMenu = protractor.element(protractor.by.css('div[role="menu"]'));
            this.optionButton = protractor.by.css('button[data-automation-id*="action_menu_"]');
            this.rootElement = rootElement;
            this.dataTable = new DataTableComponentPage(this.rootElement);
            this.tableBody = rootElement.all(protractor.by.css('div[class="adf-datatable-body"]')).first();
        }
        /**
         * @template THIS
         * @this {THIS}
         ...
         */
            function (content) {
                ...
                /** @type {?} */
                var lockIcon = row.element(protractor.by.cssContainingText('div[title="Lock"] mat-icon', 'lock'));
         ...
         */
            function (content) {
                ...
                var row = ( /** @type {?} */(this)).dataTable.getRow('Display name', content);
                /** @type {?} */
                var lockIcon = row.element(protractor.by.cssContainingText('div[title="Lock"] mat-icon', 'lock_open'));
                BrowserVisibility.waitUntilElementIsVisible(lockIcon);
                return ( /** @type {?} */(this));
            };
        /**
    ...
    var ContentNodeSelectorDialogPage = /** @class */ (function () {
        function ContentNodeSelectorDialogPage() {
            this.dialog = protractor.element(protractor.by.css("adf-content-node-selector"));
            this.header = this.dialog.element(protractor.by.css("header[data-automation-id='content-node-selector-title']"));
            this.searchInputElement = this.dialog.element(protractor.by.css("input[data-automation-id='content-node-selector-search-input']"));
            this.searchLabel = this.searchInputElement.element(protractor.by.xpath("ancestor::div[@class='mat-form-field-infix']/span/label"));
            this.siteListDropdown = this.dialog.element(protractor.by.css("mat-select[data-automation-id='site-my-files-option']"));
            this.cancelButton = protractor.element(protractor.by.css("button[data-automation-id='content-node-selector-actions-cancel']"));
            this.moveCopyButton = protractor.element(protractor.by.css("button[data-automation-id='content-node-selector-actions-choose']"));
         ...
         */
            function (siteName) {
                BrowserVisibility.waitUntilElementIsVisible(this.siteListDropdown.element(protractor.by.cssContainingText('.mat-select-value-text span', siteName)));
            };
        /**
         * @return {?}
         */
    ...
    var FormFieldsPage = /** @class */ (function () {
        function FormFieldsPage() {
            this.formContent = protractor.element(protractor.by.css('adf-form'));
            this.refreshButton = protractor.element(protractor.by.css('div[class*="form-reload-button"] mat-icon'));
            this.saveButton = protractor.element(protractor.by.cssContainingText('mat-card-actions[class*="adf-for"] span', 'SAVE'));
            this.valueLocator = protractor.by.css('input');
            this.labelLocator = protractor.by.css('label');
            this.noFormMessage = protractor.element(protractor.by.css('span[id*="no-form-message"]'));
            this.completedTaskNoFormMessage = protractor.element(protractor.by.css('div[id*="completed-form-message"] p'));
            this.attachFormButton = protractor.element(protractor.by.id('adf-no-form-attach-form-button'));
            this.selectFormDropDownArrow = protractor.element.all(protractor.by.css('adf-attach-form div[class*="mat-select-arrow"]')).first();
            this.selectFormContent = protractor.element(protractor.by.css('div[class*="mat-select-panel"]'));
            this.completeButton = protractor.element(protractor.by.id('adf-form-complete'));
            this.errorMessage = protractor.by.css('.adf-error-text-container .adf-error-text');
        }
        /**
         * @template THIS
         * @this {THIS}
         ...
         */
            function (locator, field, value) {
                /** @type {?} */
                var fieldElement = protractor.element(locator(field));
         ...
         */
            function (fieldId) {
                /** @type {?} */
                var fieldElement = protractor.element.all(protractor.by.css("adf-form-field div[id='field-" + fieldId + "-container']")).first();
                BrowserVisibility.waitUntilElementIsVisible(fieldElement);
            };
        /**
         * @param {?} fieldId
         ...
         */
            function (fieldId) {
                /** @type {?} */
                var hiddenElement = protractor.element(protractor.by.css("adf-form-field div[id='field-" + fieldId + "-container'][hidden]"));
         ...
         */
            function (fieldId) {
                /** @type {?} */
                var widget = protractor.element(protractor.by.css("adf-form-field div[id='field-" + fieldId + "-container']"));
         ...
         */
            function (fieldId, locator) {
                ...
                /** @type {?} */
                var placeHolderLocator = protractor.element(protractor.by.css(locator + "#" + fieldId)).getAttribute('placeholder');
         ...
         */
            function (locator, field, val) {
                BrowserVisibility.waitUntilElementHasValue(protractor.element(locator(field)), val);
                return ( /** @type {?} */(this));
            };
        /**
         * @template THIS
         ...
         */
            function (formName) {
                /** @type {?} */
                var formNameElement = protractor.element(protractor.by.cssContainingText('span', formName));
         ...
         */
            function (fieldId) {
                ...
                var widget = protractor.element(protractor.by.css("adf-form-field div[id='field-" + fieldId + "-container']"));
                /** @type {?} */
                var widgetReadOnly = widget.element(protractor.by.css('div[class*="adf-readonly"]'));
         ...
         */
            function (fieldId, value) {
                /** @type {?} */
                var input = protractor.element(protractor.by.id(fieldId));
    ...
    var StartTasksCloudPage = /** @class */ (function () {
        function StartTasksCloudPage() {
            this.name = protractor.element(protractor.by.css('input[id="name_id"]'));
            this.dueDate = protractor.element(protractor.by.css('input[id="date_id"]'));
            this.description = protractor.element(protractor.by.css('textarea[id="description_id"]'));
            this.priority = protractor.element(protractor.by.css('input[formcontrolname="priority"]'));
            this.startButton = protractor.element(protractor.by.css('button[id="button-start"]'));
            this.startButtonEnabled = protractor.element(protractor.by.css('button[id="button-start"]:not(disabled)'));
            this.cancelButton = protractor.element(protractor.by.css('button[id="button-cancel"]'));
            this.form = protractor.element.all(protractor.by.css('adf-cloud-start-task form')).first();
        }
        /**
         * @template THIS
         * @this {THIS}
         ...
         */
            function (error, elementRef) {
                if (elementRef === void 0) {
                    elementRef = 'mat-error';
                }
                /** @type {?} */
                var errorElement = protractor.element(protractor.by.cssContainingText(elementRef, error));
            ...
            function (locator) {
                 ...
                 */function (result) {
                    for (var i = result.length; i >= 0; i--) {
                        locator.sendKeys(protractor.protractor.Key.BACK_SPACE);
                    }
                }));
            };
    ...
    var TaskHeaderCloudPage = /** @class */ (function () {
        function TaskHeaderCloudPage() {
            this.assigneeField = protractor.element(protractor.by.css('span[data-automation-id*="assignee"] span'));
            this.statusField = protractor.element(protractor.by.css('span[data-automation-id*="status"] span'));
            this.priorityField = protractor.element(protractor.by.css('span[data-automation-id*="priority"] span'));
            this.dueDateField = protractor.element.all(protractor.by.css('span[data-automation-id*="dueDate"] span')).first();
            this.categoryField = protractor.element(protractor.by.css('span[data-automation-id*="category"] span'));
            this.createdField = protractor.element(protractor.by.css('span[data-automation-id="card-dateitem-created"] span'));
            this.parentNameField = protractor.element(protractor.by.css('span[data-automation-id*="parentName"] span'));
            this.parentTaskIdField = protractor.element(protractor.by.css('span[data-automation-id*="parentTaskId"] span'));
            this.endDateField = protractor.element.all(protractor.by.css('span[data-automation-id*="endDate"] span')).first();
            this.idField = protractor.element.all(protractor.by.css('span[data-automation-id*="id"] span')).first();
            this.descriptionField = protractor.element(protractor.by.css('span[data-automation-id*="description"] span'));
            this.taskPropertyList = protractor.element(protractor.by.css('adf-cloud-task-header adf-card-view div[class="adf-property-list"]'));
        }
        /**
         * @return {?}
         */
    ...
    var ProcessHeaderCloudPage = /** @class */ (function () {
        function ProcessHeaderCloudPage() {
            this.idField = protractor.element.all(protractor.by.css('span[data-automation-id*="id"] span')).first();
            this.nameField = protractor.element.all(protractor.by.css('span[data-automation-id*="name"] span')).first();
            this.statusField = protractor.element(protractor.by.css('span[data-automation-id*="status"] span'));
            this.initiatorField = protractor.element(protractor.by.css('span[data-automation-id*="initiator"] span'));
            this.startDateField = protractor.element.all(protractor.by.css('span[data-automation-id*="startDate"] span')).first();
            this.lastModifiedField = protractor.element.all(protractor.by.css('span[data-automation-id*="lastModified"] span')).first();
            this.parentIdField = protractor.element(protractor.by.css('span[data-automation-id*="parentId"] span'));
            this.businessKeyField = protractor.element.all(protractor.by.css('span[data-automation-id*="businessKey"] span')).first();
        }
        /**
         * @return {?}
         */
    ...
    var EditProcessFilterDialogPage = /** @class */ (function () {
        function EditProcessFilterDialogPage() {
            this.componentElement = protractor.element(protractor.by.css('adf-cloud-process-filter-dialog-cloud'));
            this.title = protractor.element(protractor.by.id('adf-process-filter-dialog-title'));
            this.filterNameInput = protractor.element(protractor.by.id('adf-filter-name-id'));
            this.saveButtonLocator = protractor.by.id('adf-save-button-id');
            this.cancelButtonLocator = protractor.by.id('adf-cancel-button-id');
        }
        /**
         * @template THIS
         * @this {THIS}
         ...
         */
            function () {
                 ...
                 */function (value) {
                    for (var i = value.length; i >= 0; i--) {
                        ( /** @type {?} */(_this)).filterNameInput.sendKeys(protractor.protractor.Key.BACK_SPACE);
                    }
                }));
                return ( /** @type {?} */(this));
            };
    ...
    var EditProcessFilterCloudComponentPage = /** @class */ (function () {
        function EditProcessFilterCloudComponentPage() {
            this.customiseFilter = protractor.element(protractor.by.id('adf-edit-process-filter-title-id'));
            this.selectedOption = protractor.element.all(protractor.by.css('mat-option[class*="mat-selected"]')).first();
            this.saveButton = protractor.element(protractor.by.css('button[data-automation-id="adf-filter-action-save"]'));
            this.saveAsButton = protractor.element(protractor.by.css('button[data-automation-id="adf-filter-action-saveAs"]'));
            this.deleteButton = protractor.element(protractor.by.css('button[data-automation-id="adf-filter-action-delete"]'));
         ...
         */
            function () {
                /** @type {?} */
                var expansionPanelExtended = protractor.element.all(protractor.by.css('mat-expansion-panel-header[class*="mat-expanded"]')).first();
                BrowserVisibility.waitUntilElementIsVisible(expansionPanelExtended);
                /** @type {?} */
                var content = protractor.element.all(protractor.by.css('div[class*="mat-expansion-panel-content "][style*="visible"]')).first();
         ...
         */
            function (option) {
                ...
                /** @type {?} */
                var statusElement = protractor.element.all(protractor.by.cssContainingText('mat-option span', option)).first();
         ...
         */
            function () {
                return protractor.element(protractor.by.css("mat-form-field[data-automation-id='status'] span")).getText();
            };
        /**
         * @template THIS
         * @this {THIS}
         ...
         */
            function (option) {
                ...
                /** @type {?} */
                var sortElement = protractor.element.all(protractor.by.cssContainingText('mat-option span', option)).first();
         ...
         */
            function () {
                /** @type {?} */
                var sortLocator = protractor.element.all(protractor.by.css("mat-form-field[data-automation-id='sort'] span")).first();
         ...
         */
            function (option) {
                ...
                /** @type {?} */
                var orderElement = protractor.element.all(protractor.by.cssContainingText('mat-option span', option)).first();
         ...
         */
            function () {
                return protractor.element(protractor.by.css("mat-form-field[data-automation-id='order'] span")).getText();
            };
        /**
         * @param {?} option
         * @return {?}
         ...
         */
            function (option) {
                /** @type {?} */
                var dropDownArrow = protractor.element.all(protractor.by.css("mat-form-field[data-automation-id='" + option + "'] div[class='mat-select-arrow-wrapper']")).first();
         ...
         */
            function (option) {
                ...
                /** @type {?} */
                var appNameElement = protractor.element.all(protractor.by.cssContainingText('mat-option span', option)).first();
            ...
            function () {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                appNameList = protractor.element.all(protractor.by.css('mat-option[data-automation-id="adf-cloud-edit-process-property-optionsappName"] span'));
         ...
         */
            function () {
                ...
                /** @type {?} */
                var dropdownOptions = protractor.element.all(protractor.by.css('.mat-select-panel mat-option'));
         ...
         */
            function (property) {
                /** @type {?} */
                var locator = protractor.element.all(protractor.by.css('input[data-automation-id="adf-cloud-edit-process-property-' + property + '"]')).first();
                BrowserVisibility.waitUntilElementIsVisible(locator);
         ...
         */
            function (property, option) {
                ...
                locator.sendKeys(protractor.protractor.Key.ENTER);
                return ( /** @type {?} */(this));
            };
        /**
         * @template THIS
         ...
         */
            function () {
                /** @type {?} */
                var disabledButton = protractor.element(protractor.by.css(("button[data-automation-id='adf-filter-action-saveAs'][disabled]")));
         ...
         */
            function () {
                /** @type {?} */
                var disabledButton = protractor.element(protractor.by.css(("button[id='adf-save-as-id'][disabled]")));
                BrowserVisibility.waitUntilElementIsClickable(( /** @type {?} */(this)).saveButton);
                BrowserVisibility.waitUntilElementIsVisible(( /** @type {?} */(this)).saveButton);
                BrowserVisibility.waitUntilElementIsNotVisible(disabledButton);
                ( /** @type {?} */(this)).saveButton.click();
    ...
    var EditTaskFilterDialogPage = /** @class */ (function () {
        function EditTaskFilterDialogPage() {
            this.componentElement = protractor.element(protractor.by.css('adf-cloud-task-filter-dialog'));
            this.title = protractor.element(protractor.by.id('adf-task-filter-dialog-title'));
            this.filterNameInput = protractor.element(protractor.by.id('adf-filter-name-id'));
            this.saveButtonLocator = protractor.by.id('adf-save-button-id');
            this.cancelButtonLocator = protractor.by.id('adf-cancel-button-id');
        }
    ...
    var EditTaskFilterCloudComponentPage = /** @class */ (function () {
        function EditTaskFilterCloudComponentPage() {
            this.customiseFilter = protractor.element(protractor.by.id('adf-edit-task-filter-title-id'));
            this.selectedOption = protractor.element.all(protractor.by.css('mat-option[class*="mat-selected"]')).first();
            this.assignee = protractor.element(protractor.by.css('input[data-automation-id="adf-cloud-edit-task-property-assignee"]'));
            this.priority = protractor.element(protractor.by.css('input[data-automation-id="adf-cloud-edit-task-property-priority"]'));
            this.taskName = protractor.element(protractor.by.css('input[data-automation-id="adf-cloud-edit-task-property-taskName"]'));
            this.id = protractor.element(protractor.by.css('input[data-automation-id="adf-cloud-edit-task-property-taskId"]'));
            this.processDefinitionId = protractor.element(protractor.by.css('input[data-automation-id="adf-cloud-edit-task-property-processDefinitionId"]'));
            this.processInstanceId = protractor.element(protractor.by.css('input[data-automation-id="adf-cloud-edit-task-property-processInstanceId"]'));
            this.lastModifiedFrom = protractor.element(protractor.by.css('input[data-automation-id="adf-cloud-edit-task-property-lastModifiedFrom"]'));
            this.lastModifiedTo = protractor.element(protractor.by.css('input[data-automation-id="adf-cloud-edit-task-property-lastModifiedTo"]'));
            this.parentTaskId = protractor.element(protractor.by.css('input[data-automation-id="adf-cloud-edit-task-property-parentTaskId"]'));
            this.owner = protractor.element(protractor.by.css('input[data-automation-id="adf-cloud-edit-task-property-owner"]'));
            this.saveButton = protractor.element(protractor.by.css('[data-automation-id="adf-filter-action-save"]'));
            this.saveAsButton = protractor.element(protractor.by.css('[data-automation-id="adf-filter-action-saveAs"]'));
            this.deleteButton = protractor.element(protractor.by.css('[data-automation-id="adf-filter-action-delete"]'));
         ...
         */
            function () {
                return protractor.element.all(protractor.by.css("mat-select[data-automation-id='adf-cloud-edit-task-property-status'] span")).first().getText();
            };
        /**
         * @template THIS
         * @this {THIS}
         ...
         */
            function () {
                /** @type {?} */
                var elementSort = protractor.element.all(protractor.by.css("mat-select[data-automation-id='adf-cloud-edit-task-property-sort'] span")).first();
         ...
         */
            function () {
                return protractor.element.all(protractor.by.css("mat-select[data-automation-id='adf-cloud-edit-task-property-order'] span")).first().getText();
            };
        /**
         * @param {?} option
         * @return {?}
         ...
         */
            function (option) {
                /** @type {?} */
                var dropDownArrow = protractor.element.all(protractor.by.css("mat-form-field[data-automation-id='" + option + "'] div[class*='arrow']")).first();
                BrowserVisibility.waitUntilElementIsVisible(dropDownArrow);
                dropDownArrow.click();
                BrowserVisibility.waitUntilElementIsVisible(this.selectedOption);
            };
         ...
         */
            function () {
                /** @type {?} */
                var locator = protractor.element.all(protractor.by.css("mat-select[data-automation-id='adf-cloud-edit-task-property-appName'] span")).first();
                BrowserVisibility.waitUntilElementIsVisible(locator);
         ...
         */
            function (property, option) {
                /** @type {?} */
                var locator = protractor.element(protractor.by.css('input[data-automation-id="adf-cloud-edit-task-property-' + property + '"]'));
                BrowserVisibility.waitUntilElementIsVisible(locator);
                locator.clear();
                locator.sendKeys(option);
                locator.sendKeys(protractor.protractor.Key.ENTER);
    ...
    var GroupCloudComponentPage = /** @class */ (function () {
        function GroupCloudComponentPage() {
            this.groupCloudSearch = protractor.element(protractor.by.css('input[data-automation-id="adf-cloud-group-search-input"]'));
        }
        /**
         * @template THIS
         * @this {THIS}
         ...
         */
            function (name) {
                 ...
                 */function () {
                    ...
                    ( /** @type {?} */(_this)).groupCloudSearch.sendKeys(protractor.protractor.Key.BACK_SPACE);
         ...
         */
            function (name) {
                ...
                ( /** @type {?} */(this)).groupCloudSearch.sendKeys(protractor.protractor.Key.BACK_SPACE);
         ...
         */
            function (name) {
                /** @type {?} */
                var groupRow = protractor.element.all(protractor.by.cssContainingText('mat-option span', name)).first();
         ...
         */
            function (group) {
                BrowserVisibility.waitUntilElementIsVisible(protractor.element(protractor.by.cssContainingText('mat-chip[data-automation-id*="adf-cloud-group-chip-"]', group)));
                return ( /** @type {?} */(this));
            };
    ...
    var PeopleCloudComponentPage = /** @class */ (function () {
        function PeopleCloudComponentPage() {
            this.peopleCloudSearch = protractor.element(protractor.by.css('input[data-automation-id="adf-people-cloud-search-input"]'));
            this.assigneeField = protractor.element(protractor.by.css('input[data-automation-id="adf-people-cloud-search-input"]'));
        }
        /**
         * @template THIS
         * @this {THIS}
         ...
         */
            function (name) {
                 ...
                 */function () {
                    ...
                    ( /** @type {?} */(_this)).peopleCloudSearch.sendKeys(protractor.protractor.Key.BACK_SPACE);
         ...
         */
            function (name) {
                ...
                ( /** @type {?} */(this)).peopleCloudSearch.sendKeys(protractor.protractor.Key.BACK_SPACE);
         ...
         */
            function (name) {
                /** @type {?} */
                var assigneeRow = protractor.element(protractor.by.cssContainingText('mat-option span.adf-people-label-name', name));
         ...
         */
            function (person) {
                BrowserVisibility.waitUntilElementIsVisible(protractor.element(protractor.by.cssContainingText('mat-chip-list mat-chip', person)));
                return ( /** @type {?} */(this));
            };
        /**
         * @return {?}
    ...
    var ProcessFiltersCloudComponentPage = /** @class */ (function () {
        function ProcessFiltersCloudComponentPage(filter) {
            this.filterIcon = protractor.by.xpath("ancestor::div[@class='mat-list-item-content']/mat-icon");
            this.filter = filter;
        }
        /**
         * @template THIS
    ...
    var ProcessListCloudComponentPage = /** @class */ (function () {
        function ProcessListCloudComponentPage() {
            ...
            this.processList = protractor.element(protractor.by.css('adf-cloud-process-list'));
            this.noProcessFound = protractor.element.all(protractor.by.css("div[class='adf-empty-content__title']")).first();
    ...
    var TaskFiltersCloudComponentPage = /** @class */ (function () {
        function TaskFiltersCloudComponentPage(filter) {
            this.taskIcon = protractor.by.xpath("ancestor::div[@class='mat-list-item-content']/mat-icon");
            this.filter = filter;
        }
        /**
         * @template THIS
    ...
    var TaskListCloudComponentPage = /** @class */ (function () {
        function TaskListCloudComponentPage() {
            this.taskList = protractor.element(protractor.by.css('adf-cloud-task-list'));
            this.noTasksFound = protractor.element.all(protractor.by.css("div[class='adf-empty-content__title']")).first();
    ...
    var StartProcessCloudPage = /** @class */ (function () {
        function StartProcessCloudPage() {
            this.defaultProcessName = protractor.element(protractor.by.css('input[id="processName"]'));
            this.processNameInput = protractor.element(protractor.by.id('processName'));
            this.selectProcessDropdownArrow = protractor.element(protractor.by.css('button[id="adf-select-process-dropdown"]'));
            this.cancelProcessButton = protractor.element(protractor.by.id('cancel_process'));
            this.formStartProcessButton = protractor.element(protractor.by.css('button[data-automation-id="adf-form-start process"]'));
            this.startProcessButton = protractor.element(protractor.by.css('button[data-automation-id="btn-start"]'));
            this.noProcess = protractor.element(protractor.by.id('no-process-message'));
            this.processDefinition = protractor.element(protractor.by.css('input[id="processDefinitionName"]'));
            this.processDefinitionOptionsPanel = protractor.element(protractor.by.css('div[class*="processDefinitionOptions"]'));
        }
        /**
         * @return {?}
         */
         ...
         */
            function () {
                this.processDefinition.sendKeys(protractor.protractor.Key.ARROW_DOWN);
                return protractor.browser.actions().sendKeys(protractor.protractor.Key.ENTER).perform();
            };
        /**
         * @return {?}
         */
         ...
         */
            function (name) {
                /** @type {?} */
                var selectProcessDropdown = protractor.element(protractor.by.cssContainingText('.mat-option-text', name));
    ...
    var TaskFormCloudComponent = /** @class */ (function () {
        function TaskFormCloudComponent() {
            this.cancelButton = protractor.element(protractor.by.css("button[id='adf-cloud-cancel-task']"));
            this.completeButton = protractor.element(protractor.by.css('button[adf-cloud-complete-task]'));
        }
        /**
         * @template THIS
         * @this {THIS}
    ...
    var TestingAlfrescoApiService = /** @class */ (function (_super) {
        ...
        function TestingAlfrescoApiService(appConfig) {
            ...
            _this.config = {};
            /** @type {?} */
            var oauth = Object.assign({}, _this.appConfig.get(adfCore.AppConfigValues.OAUTHCONFIG, null));
            _this.config = new jsApi.AlfrescoApiConfig({
                provider: _this.appConfig.get(adfCore.AppConfigValues.PROVIDERS),
                hostEcm: _this.appConfig.get(adfCore.AppConfigValues.ECMHOST),
                hostBpm: _this.appConfig.get(adfCore.AppConfigValues.BPMHOST),
                authType: _this.appConfig.get(adfCore.AppConfigValues.AUTHTYPE, 'BASIC'),
                contextRootBpm: _this.appConfig.get(adfCore.AppConfigValues.CONTEXTROOTBPM),
                contextRoot: _this.appConfig.get(adfCore.AppConfigValues.CONTEXTROOTECM),
                disableCsrf: _this.appConfig.get(adfCore.AppConfigValues.DISABLECSRF),
                withCredentials: _this.appConfig.get(adfCore.AppConfigValues.AUTH_WITH_CREDENTIALS, false),
                oauth2: oauth
            });
            return _this;
        }
         ...
         */
            function () {
                if (this.alfrescoApi) {
                    ...
                    this.alfrescoApi = new jsApi.AlfrescoApiCompatibility(this.config);
                }
                return this.alfrescoApi;
            };
        return TestingAlfrescoApiService;
    }(adfCore.AlfrescoApiService));
    ...
    var AppListCloudPage = /** @class */ (function () {
        function AppListCloudPage() {
            this.apsAppsContainer = protractor.element(protractor.by.css('adf-cloud-app-list'));
        }
        /**
         * @return {?}
         */
         ...
         */
            function (applicationName) {
                /** @type {?} */
                var app = protractor.element(protractor.by.css('mat-card[title="' + applicationName + '"]'));
    ...
    var TestingService = /** @class */ (function () {
        ...
        /** @nocollapse */ TestingService.ngInjectableDef = i0.defineInjectable({ factory: function TestingService_Factory() { return new TestingService(); }, token: TestingService, providedIn: "root" });
...
//# sourceMappingURL=adf-testing.umd.js.map