...
import { Injectable, NgModule, Component, EventEmitter, Input, Output, ViewChild, ViewEncapsulation, ContentChild, Directive, TemplateRef, Inject, defineInjectable, inject, NgZone } from '@angular/core';
import { FormBuilder, Validators, FormControl, FormsModule, ReactiveFormsModule } from '@angular/forms';
import { AlfrescoApiService, AppsProcessService, LogService, ContentService, AppConfigService, CardViewDateItemModel, CardViewTextItemModel, TranslationService, CustomEmptyContentTemplateDirective, CommentProcessService, ThumbnailService, EmptyListComponent, PeopleProcessService, UserProcessModel, AuthenticationService, CardViewUpdateService, FormService, UserPreferencesService, UserPreferenceValues, FormFieldModel, FormModel, DataColumnListComponent, TRANSLATION_PROVIDER, CoreModule, PaginationComponent, CustomLoadingContentTemplateDirective, DataTableSchema, AppConfigValues, ActivitiContentService, ProcessContentService, FormOutcomeModel, WidgetVisibilityService, FormRenderingService, EcmModelService, FormEvent, FormErrorEvent, FormOutcomeEvent, NodeService, FormBaseComponent, CardViewMapItemModel, BpmUserService, MOMENT_DATE_FORMATS, MomentDateAdapter, UploadService, UploadWidgetComponent, NodesApiService, WidgetComponent, SitesService, SearchService, ExternalAlfrescoApiService } from '@alfresco/adf-core';
...
var ProcessFilterService = /** @class */ (function () {
    ...
    function (appId) {
        ...
        function (response) {
            ...
            function (filter$$1) {
                /** @type {?} */
                var filterModel = new FilterProcessRepresentationModel(filter$$1);
    ...
    function (filterId, appId) {
        ...
        function (response) {
             ...
             * @return {?}
             */
            function (filter$$1) { return filter$$1.id === filterId; }));
        })), catchError((/**
         * @param {?} err
         * @return {?}
         */
    ...
    function (filterName, appId) {
        ...
        function (response) {
             ...
             * @return {?}
             */
            function (filter$$1) { return filter$$1.name === filterName; }));
        })), catchError((/**
         * @param {?} err
         * @return {?}
         */
...
var ProcessFiltersComponent = /** @class */ (function () {
    ...
    function (changes) {
        ...
        /** @type {?} */
        var filter$$1 = changes['filterParam'];
...
var TaskFilterService = /** @class */ (function () {
    ...
    function (appId) {
        ...
        function (response) {
            ...
            function (filter$$1) {
                /** @type {?} */
                var filterModel = new FilterRepresentationModel(filter$$1);
                filters.push(filterModel);
            }));
            return filters;
        })), catchError((/**
    ...
    function (filterId, appId) {
         ...
         * @return {?}
         */
        function (filter$$1) { return filter$$1.id === filterId; })); })), catchError((/**
         * @param {?} err
         * @return {?}
         */
        function (err) { return _this.handleError(err); })));
    ...
    function (taskName, appId) {
         ...
         * @return {?}
         */
        function (filter$$1) { return filter$$1.name === taskName; })); })), catchError((/**
         * @param {?} err
         * @return {?}
         */
        function (err) { return _this.handleError(err); })));
