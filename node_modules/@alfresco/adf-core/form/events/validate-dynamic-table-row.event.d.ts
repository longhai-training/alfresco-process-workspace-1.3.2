...
export declare class ValidateDynamicTableRowEvent extends FormFieldEvent {
    row: DynamicTableRow;
    summary: DynamicRowValidationSummary;
    isValid: boolean;
    constructor(form: FormModel, field: FormFieldModel, row: DynamicTableRow, summary: DynamicRowValidationSummary);
}
