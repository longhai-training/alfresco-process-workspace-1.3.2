...
export declare class LoginComponent implements OnInit {
     ...
     * @param translate
     */
    constructor(_fb: FormBuilder, authService: AuthenticationService, translateService: TranslationService, logService: LogService, router: Router, appConfig: AppConfigService, userPreferences: UserPreferencesService, location: Location, route: ActivatedRoute);
    ngOnInit(): void;
    submit(): void;
    /**
