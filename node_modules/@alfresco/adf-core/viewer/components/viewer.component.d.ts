...
export declare class ViewerComponent implements OnChanges, OnInit, OnDestroy {
    ...
    private extensions;
    private mimeTypes;
    constructor(apiService: AlfrescoApiService, viewUtils: ViewUtilService, logService: LogService, location: Location, extensionService: AppExtensionService, el: ElementRef, router: Router, previousRouteService: PreviousRouteService);
    ...
    getViewerTypeByExtension(extension: string): "text" | "image" | "media" | "pdf" | "unknown" | "custom";
