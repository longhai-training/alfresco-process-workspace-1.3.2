...
export declare class CardViewSelectItemModel<T> extends CardViewBaseItemModel implements CardViewItem, DynamicComponentModel {
    type: string;
    options$: Observable<CardViewSelectItemOption<T>[]>;
    constructor(cardViewSelectItemProperties: CardViewSelectItemProperties<T>);
    readonly displayValue: Observable<string>;
}
