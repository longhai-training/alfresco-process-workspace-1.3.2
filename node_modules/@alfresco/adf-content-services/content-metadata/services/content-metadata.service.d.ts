...
export declare class ContentMetadataService {
    ...
    constructor(basicPropertiesService: BasicPropertiesService, contentMetadataConfigFactory: ContentMetadataConfigFactory, propertyGroupTranslatorService: PropertyGroupTranslatorService, propertyDescriptorsService: PropertyDescriptorsService);
    getBasicProperties(node: Node): Observable<CardViewItem[]>;
    getGroupedProperties(node: Node, presetName?: string): Observable<CardViewGroup[]>;
