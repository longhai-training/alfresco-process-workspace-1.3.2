 ...
 */
export declare class ContentNodeSelectorService {
     ...
     */
    search(searchTerm: string, rootNodeId?: string, skipCount?: number, maxItems?: number, extraNodeIds?: string[]): Observable<NodePaging>;
}
