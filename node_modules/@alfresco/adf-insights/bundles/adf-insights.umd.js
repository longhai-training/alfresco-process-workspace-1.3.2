(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('ng2-charts'), require('@angular/material'), require('moment-es6'), require('@angular/flex-layout'), require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('@alfresco/adf-core')) :
    typeof define === 'function' && define.amd ? define('@alfresco/adf-insights', ['exports', 'rxjs', 'rxjs/operators', 'ng2-charts', '@angular/material', 'moment-es6', '@angular/flex-layout', '@angular/common', '@angular/core', '@angular/forms', '@alfresco/adf-core'], factory) :
    (factory((global.alfresco = global.alfresco || {}, global.alfresco['adf-insights'] = {}),global.rxjs,global.rxjs.operators,global['ng2-charts'],global['@angular/material'],global['moment-es6'],global['@angular/flex-layout'],global.ng.common,global.ng.core,global.ng.forms,global['@alfresco/adf-core']));
}(this, (function (exports,rxjs,operators,ng2Charts,material,moment,flexLayout,common,core,forms,adfCore) { 'use strict';
    ...
    var AnalyticsComponent = /** @class */ (function () {
        function AnalyticsComponent() {
            ...
            this.editReport = new core.EventEmitter();
            this.reportSaved = new core.EventEmitter();
            this.reportDeleted = new core.EventEmitter();
        }
        /**
         * @param {?} changes
         * @return {?}
        ...
        AnalyticsComponent.propDecorators = {
            ...
            reportId: [{ type: core.Input }],
            hideParameters: [{ type: core.Input }],
            editReport: [{ type: core.Output }],
            reportSaved: [{ type: core.Output }],
            reportDeleted: [{ type: core.Output }],
            analyticsGenerator: [{ type: core.ViewChild, args: ['analyticsGenerator',] }]
        };
     ...
     */
    var ParameterValueModel = /** @class */ (function () {
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var ReportDefinitionModel = /** @class */ (function () {
         ...
         * @return {?}
         */
        ReportDefinitionModel.prototype.findParam = /**
         * @param {?} name
         * @return {?}
         */
            function (name) {
    ...
    ***************************************************************************** */
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DetailsTableChart = /** @class */ (function (_super) {
         ...
         * @return {?}
         */
        DetailsTableChart.prototype.hasDetailsTable = /**
         * @return {?}
         */
            function () {
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var MultiBarChart = /** @class */ (function (_super) {
    ...
    var AnalyticsService = /** @class */ (function () {
         ...
         */
            function (appId) {
                var _this = this;
                return rxjs.from(this.apiService.getInstance().activiti.reportApi.getReportList())
                    .pipe(operators.map(( /**
             * @param {?} res
             * @return {?}
             */function (res) {
         ...
         */
            function (reportId) {
                var _this = this;
                return rxjs.from(this.apiService.getInstance().activiti.reportApi.getReportParams(reportId))
                    .pipe(operators.map(( /**
             * @param {?} res
             * @return {?}
             */function (res) {
         ...
         */
            function () {
                var _this = this;
                return rxjs.from(this.apiService.getInstance().activiti.reportApi.getProcessDefinitions())
                    .pipe(operators.map(( /**
             * @param {?} res
             * @return {?}
             */function (res) {
         ...
         */
            function (appId) {
                ...
                return rxjs.from(this.apiService.getInstance().activiti.processDefinitionsApi.getProcessDefinitions(options))
                    .pipe(operators.map(( /**
             * @param {?} res
             * @return {?}
             */function (res) {
         ...
         */
            function (reportId, processDefinitionId) {
                var _this = this;
                return rxjs.from(this.apiService.getInstance().activiti.reportApi.getTasksByProcessDefinitionId(reportId, processDefinitionId))
                    .pipe(operators.map(( /**
             * @param {?} res
             * @return {?}
             */function (res) {
         ...
         */
            function (reportId, paramsQuery) {
                var _this = this;
                return rxjs.from(this.apiService.getInstance().activiti.reportApi.getReportsByParams(reportId, paramsQuery))
                    .pipe(operators.map(( /**
             * @param {?} res
             * @return {?}
             */function (res) {
         ...
         */
            function () {
                var _this = this;
                return rxjs.from(this.apiService.getInstance().activiti.reportApi.createDefaultReports())
                    .pipe(operators.map(this.toJson), operators.catchError(( /**
             * @param {?} err
             * @return {?}
             */function (err) { return _this.handleError(err); })));
            };
         ...
         */
            function (reportId, name) {
                var _this = this;
                return rxjs.from(this.apiService.getInstance().activiti.reportApi.updateReport(reportId, name))
                    .pipe(operators.map(( /**
             * @return {?}
             */function () { return _this.logService.info('upload'); })), operators.catchError(( /**
                 * @param {?} err
                 * @return {?}
                 */function (err) { return _this.handleError(err); })));
            };
         ...
         */
            function (reportId, paramsQuery) {
                var _this = this;
                return rxjs.from(this.apiService.getInstance().activiti.reportApi.exportToCsv(reportId, paramsQuery))
                    .pipe(operators.map(( /**
             * @param {?} res
             * @return {?}
             */function (res) {
         ...
         */
            function (reportId, paramsQuery) {
                var _this = this;
                return rxjs.from(this.apiService.getInstance().activiti.reportApi.saveReport(reportId, paramsQuery))
                    .pipe(operators.map(( /**
             * @return {?}
             */function () {
         ...
         */
            function (reportId) {
                var _this = this;
                return rxjs.from(this.apiService.getInstance().activiti.reportApi.deleteReport(reportId))
                    .pipe(operators.map(( /**
             * @return {?}
             */function () {
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var AnalyticsGeneratorComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        AnalyticsGeneratorComponent.prototype.ngOnChanges = /**
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        AnalyticsGeneratorComponent.prototype.generateReport = /**
         * @param {?} reportId
         * @param {?} reportParamQuery
         * @return {?}
         */
            function (reportId, reportParamQuery) {
                var _this = this;
         ...
         * @return {?}
         */
        AnalyticsGeneratorComponent.prototype.reset = /**
         * @return {?}
         */
            function () {
                if (this.reports) {
         ...
         * @return {?}
         */
        AnalyticsGeneratorComponent.prototype.refresh = /**
         * @param {?} report
         * @return {?}
         */
            function (report) {
         ...
         * @return {?}
         */
        AnalyticsGeneratorComponent.prototype.toggleDetailsTable = /**
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        AnalyticsGeneratorComponent.prototype.isShowDetails = /**
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        AnalyticsGeneratorComponent.prototype.isCurrent = /**
         * @param {?} position
         * @return {?}
         */
            function (position) {
         ...
         * @return {?}
         */
        AnalyticsGeneratorComponent.prototype.selectCurrent = /**
         * @param {?} position
         * @return {?}
         */
            function (position) {
         ...
         * @return {?}
         */
        AnalyticsGeneratorComponent.prototype.selectFirstReport = /**
         * @return {?}
         */
            function () {
        ...
        /** @nocollapse */
        AnalyticsGeneratorComponent.ctorParameters = function () {
            return [
        ...
        AnalyticsGeneratorComponent.propDecorators = {
            reportId: [{ type: core.Input }],
            reportParamQuery: [{ type: core.Input }],
    ...
    var AnalyticsReportListComponent = /** @class */ (function () {
        function AnalyticsReportListComponent(analyticsService) {
            ...
            this.reportClick = new core.EventEmitter();
            this.success = new core.EventEmitter();
            this.error = new core.EventEmitter();
            this.reports = [];
            this.report$ = new rxjs.Observable(( /**
             * @param {?} observer
             * @return {?}
        ...
        /** @nocollapse */
        AnalyticsReportListComponent.ctorParameters = function () {
            return [
                { type: AnalyticsService }
            ];
        };
     ...
     * limitations under the License.
     */
    var ReportDateRange = /** @class */ (function () {
    ...
    var AnalyticsReportParametersComponent = /** @class */ (function () {
        function AnalyticsReportParametersComponent(analyticsService, formBuilder, logService, contentService, dialog) {
            ...
            this.formValueChanged = new core.EventEmitter();
            this.saveReportSuccess = new core.EventEmitter();
            this.deleteReportSuccess = new core.EventEmitter();
            this.onDropdownChanged = new core.EventEmitter();
            this.successReportParams = new core.EventEmitter();
            this.successParamOpt = new core.EventEmitter();
         ...
         */
            function (parameters) {
                 ...
                 */function (param) {
                    switch (param.type) {
                        case 'dateRange':
                            formBuilderGroup.dateRange = new forms.FormGroup({}, forms.Validators.required);
                            break;
                        case 'processDefinition':
                            formBuilderGroup.processDefGroup = new forms.FormGroup({
                                processDefinitionId: new forms.FormControl(null, forms.Validators.required, null)
                            }, forms.Validators.required);
                            break;
                        case 'duration':
                            formBuilderGroup.durationGroup = new forms.FormGroup({
                                duration: new forms.FormControl(null, forms.Validators.required, null)
                            }, forms.Validators.required);
                            break;
                        case 'dateInterval':
                            formBuilderGroup.dateIntervalGroup = new forms.FormGroup({
                                dateRangeInterval: new forms.FormControl(null, forms.Validators.required, null)
                            }, forms.Validators.required);
                            break;
                        case 'boolean':
                            formBuilderGroup.typeFilteringGroup = new forms.FormGroup({
                                typeFiltering: new forms.FormControl(null, forms.Validators.required, null)
                            }, forms.Validators.required);
                            break;
                        case 'task':
                            formBuilderGroup.taskGroup = new forms.FormGroup({
                                taskName: new forms.FormControl(null, forms.Validators.required, null)
                            }, forms.Validators.required);
                            break;
                        case 'integer':
                            formBuilderGroup.processInstanceGroup = new forms.FormGroup({
                                slowProcessInstanceInteger: new forms.FormControl(null, forms.Validators.required, null)
                            }, forms.Validators.required);
                            break;
                        case 'status':
                            formBuilderGroup.statusGroup = new forms.FormGroup({
                                status: new forms.FormControl(null, forms.Validators.required, null)
                            }, forms.Validators.required);
                            break;
                        default:
                            return;
        ...
        /** @nocollapse */
        AnalyticsReportParametersComponent.ctorParameters = function () {
            return [
                { type: AnalyticsService },
        ...
        AnalyticsReportParametersComponent.propDecorators = {
            appId: [{ type: core.Input }],
            reportId: [{ type: core.Input }],
            hideComponent: [{ type: core.Input }],
            success: [{ type: core.Output }],
            error: [{ type: core.Output }],
            edit: [{ type: core.Output }],
            formValueChanged: [{ type: core.Output }],
            saveReportSuccess: [{ type: core.Output }],
            deleteReportSuccess: [{ type: core.Output }],
            reportNameDialog: [{ type: core.ViewChild, args: ['reportNameDialog',] }]
        };
    ...
    var DiagramEndEventComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramEndEventComponent.ctorParameters = function () {
            return [
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramEventComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramEventComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
    ...
    var DiagramStartEventComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramStartEventComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: DiagramColorService }
            ];
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramAlfrescoPublishTaskComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramAlfrescoPublishTaskComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
            };
        DiagramAlfrescoPublishTaskComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        template: "<diagram-task [data]=\"data\"></diagram-task>\n<diagram-icon-alfresco-publish-task [data]=\"data\"></diagram-icon-alfresco-publish-task>"
                    }] }
        ];
        /** @nocollapse */
        DiagramAlfrescoPublishTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramBoxPublishTaskComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramBoxPublishTaskComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
            };
        ...
        /** @nocollapse */
        DiagramBoxPublishTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramBusinessRuleTaskComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramBusinessRuleTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramCamelTaskComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramCamelTaskComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
            };
        ...
        /** @nocollapse */
        DiagramCamelTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
    ...
    var DiagramContainerServiceTaskComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramContainerServiceTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramGoogleDrivePublishTaskComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramGoogleDrivePublishTaskComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
            };
        ...
        /** @nocollapse */
        DiagramGoogleDrivePublishTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramManualTaskComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramManualTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramMuleTaskComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramMuleTaskComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
            };
        ...
        /** @nocollapse */
        DiagramMuleTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramReceiveTaskComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramReceiveTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramRestCallTaskComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramRestCallTaskComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
            };
        ...
        /** @nocollapse */
        DiagramRestCallTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramScriptTaskComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramScriptTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramSendTaskComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramSendTaskComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
            };
        ...
        /** @nocollapse */
        DiagramSendTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramServiceTaskComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramServiceTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramTaskComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramTaskComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramUserTaskComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramUserTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramBoundaryEventComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramBoundaryEventComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.center.x = this.data.x + (this.data.width / 2);
        ...
        /** @nocollapse */
        DiagramBoundaryEventComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: DiagramColorService }
            ];
    ...
    var DiagramThrowEventComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramThrowEventComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: DiagramColorService }
            ];
    ...
    var DiagramIntermediateCatchingEventComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramIntermediateCatchingEventComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: DiagramColorService }
            ];
    ...
    var DiagramEventGatewayComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramEventGatewayComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: DiagramColorService }
            ];
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramExclusiveGatewayComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramExclusiveGatewayComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
        ...
        /** @nocollapse */
        DiagramExclusiveGatewayComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: DiagramColorService }
            ];
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramGatewayComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramGatewayComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.center.x = this.data.x;
        ...
        DiagramGatewayComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        template: "<raphael-rhombus [elementId]=\"data.id\" [center]=\"center\" [width]=\"width\" [height]=\"height\" [stroke]=\"options.stroke\" [strokeWidth]=\"options.strokeWidth\"\n                 [fillColors]=\"options.fillColors\" [fillOpacity]=\"options.fillOpacity\"></raphael-rhombus>\n<diagram-tooltip [data]=\"data\"></diagram-tooltip>\n"
                    }] }
        ];
        /** @nocollapse */
        DiagramGatewayComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: DiagramColorService }
            ];
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramInclusiveGatewayComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramInclusiveGatewayComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.center.x = this.data.x + (this.data.width / 2);
        ...
        /** @nocollapse */
        DiagramInclusiveGatewayComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: DiagramColorService }
            ];
    ...
    var DiagramParallelGatewayComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramParallelGatewayComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: DiagramColorService }
            ];
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramSequenceFlowComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramSequenceFlowComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
            };
        ...
        /** @nocollapse */
        DiagramSequenceFlowComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
        DiagramSequenceFlowComponent.propDecorators = {
            flow: [{ type: core.Input }],
            error: [{ type: core.Output }]
        };
     ...
     * limitations under the License.
     */
    var DiagramElementPropertyModel = /** @class */ (function () {
     ...
     * limitations under the License.
     */
    var DiagramEventDefinitionModel = /** @class */ (function () {
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramElementModel = /** @class */ (function () {
     ...
     * limitations under the License.
     */
    var DiagramWayPointModel = /** @class */ (function () {
     ...
     * limitations under the License.
     */
    var DiagramLaneElementModel = /** @class */ (function () {
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramPoolElementModel = /** @class */ (function () {
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramsService = /** @class */ (function () {
        function DiagramsService(apiService, logService) {
            this.apiService = apiService;
            this.logService = logService;
        }
        /**
         ...
         * @return {?}
         */
        DiagramsService.prototype.getProcessDefinitionModel = /**
         * @param {?} processDefinitionId
         * @return {?}
         */
            function (processDefinitionId) {
                var _this = this;
                return rxjs.from(this.apiService.getInstance().activiti.modelJsonBpmnApi.getModelJSON(processDefinitionId))
         ...
         * @return {?}
         */
        DiagramsService.prototype.getRunningProcessDefinitionModel = /**
         * @param {?} processInstanceId
         * @return {?}
         */
            function (processInstanceId) {
                var _this = this;
                return rxjs.from(this.apiService.getInstance().activiti.modelJsonBpmnApi.getModelJSONForProcessDefinition(processInstanceId))
                    .pipe(operators.catchError(( /**
             * @param {?} err
             * @return {?}
             */function (err) { return _this.handleError(err); })));
         ...
         * @return {?}
         */
        DiagramsService.prototype.handleError = /**
         * @private
         * @param {?} error
         * @return {?}
         */
        ...
        /** @nocollapse */
        DiagramsService.ctorParameters = function () {
            return [
                { type: adfCore.AlfrescoApiService },
                { type: adfCore.LogService }
            ];
    ...
    var DiagramComponent = /** @class */ (function () {
        ...
        DiagramComponent.propDecorators = {
            ...
            metricPercentages: [{ type: core.Input }],
            metricColor: [{ type: core.Input }],
            metricType: [{ type: core.Input }],
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramContainerIconEventTaskComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramContainerIconEventTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
    ...
    var DiagramIconAlfrescoPublishTaskComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramIconAlfrescoPublishTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramIconBoxPublishTaskComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramIconBoxPublishTaskComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
        ...
        DiagramIconBoxPublishTaskComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        template: "<raphael-icon-box-publish [position]=\"position\" [stroke]=\"options.stroke\" [strokeWidth]=\"options.strokeWidth\"\n                   [fillColors]=\"options.fillColors\" [fillOpacity]=\"options.fillOpacity\"></raphael-icon-box-publish>"
                    }] }
        ];
        /** @nocollapse */
        DiagramIconBoxPublishTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramIconBusinessRuleTaskComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramIconBusinessRuleTaskComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.position = { x: this.data.x + 4, y: this.data.y + 4 };
        ...
        DiagramIconBusinessRuleTaskComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        template: "<raphael-icon-business-rule [position]=\"position\" [stroke]=\"options.stroke\" [strokeWidth]=\"options.strokeWidth\"\n                   [fillColors]=\"options.fillColors\" [fillOpacity]=\"options.fillOpacity\"></raphael-icon-business-rule>"
                    }] }
        ];
        /** @nocollapse */
        DiagramIconBusinessRuleTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramIconCamelTaskComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramIconCamelTaskComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
        ...
        DiagramIconCamelTaskComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        template: "<raphael-icon-camel [position]=\"position\" [stroke]=\"options.stroke\" [strokeWidth]=\"options.strokeWidth\"\n                   [fillColors]=\"options.fillColors\" [fillOpacity]=\"options.fillOpacity\"></raphael-icon-camel>"
                    }] }
        ];
        /** @nocollapse */
        DiagramIconCamelTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
    ...
    var DiagramIconErrorComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramIconErrorComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramIconGoogleDrivePublishTaskComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramIconGoogleDrivePublishTaskComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.position = { x: this.data.x + 6, y: this.data.y + 6 };
        ...
        DiagramIconGoogleDrivePublishTaskComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        template: "<raphael-icon-google-drive-publish [position]=\"position\" [stroke]=\"options.stroke\" [strokeWidth]=\"options.strokeWidth\"\n                   [fillColors]=\"options.fillColors\" [fillOpacity]=\"options.fillOpacity\"></raphael-icon-google-drive-publish>"
                    }] }
        ];
        /** @nocollapse */
        DiagramIconGoogleDrivePublishTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramIconManualTaskComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramIconManualTaskComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.position = { x: this.data.x + 4, y: this.data.y + 4 };
        ...
        DiagramIconManualTaskComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        template: "<raphael-icon-manual [position]=\"position\" [stroke]=\"options.stroke\" [strokeWidth]=\"options.strokeWidth\"\n                   [fillColors]=\"options.fillColors\" [fillOpacity]=\"options.fillOpacity\"></raphael-icon-manual>"
                    }] }
        ];
        /** @nocollapse */
        DiagramIconManualTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
    ...
    var DiagramIconMessageComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramIconMessageComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramIconMuleTaskComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramIconMuleTaskComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
        ...
        DiagramIconMuleTaskComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        template: "<raphael-icon-mule [position]=\"position\" [stroke]=\"options.stroke\" [strokeWidth]=\"options.strokeWidth\"\n                   [fillColors]=\"options.fillColors\" [fillOpacity]=\"options.fillOpacity\"></raphael-icon-mule>"
                    }] }
        ];
        /** @nocollapse */
        DiagramIconMuleTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramIconReceiveTaskComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramIconReceiveTaskComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
        ...
        DiagramIconReceiveTaskComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        template: "<raphael-icon-receive [position]=\"position\" [stroke]=\"options.stroke\" [strokeWidth]=\"options.strokeWidth\"\n                   [fillColors]=\"options.fillColors\" [fillOpacity]=\"options.fillOpacity\"></raphael-icon-receive>"
                    }] }
        ];
        /** @nocollapse */
        DiagramIconReceiveTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
    ...
    var DiagramIconRestCallTaskComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramIconRestCallTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramIconScriptTaskComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramIconScriptTaskComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.position = { x: this.data.x + 4, y: this.data.y + 4 };
        ...
        DiagramIconScriptTaskComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        template: "<raphael-icon-script [position]=\"position\" [stroke]=\"options.stroke\" [strokeWidth]=\"options.strokeWidth\"\n                   [fillColors]=\"options.fillColors\" [fillOpacity]=\"options.fillOpacity\"></raphael-icon-script>"
                    }] }
        ];
        /** @nocollapse */
        DiagramIconScriptTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramIconSendTaskComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramIconSendTaskComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.position = { x: this.data.x + 4, y: this.data.y + 4 };
        ...
        /** @nocollapse */
        DiagramIconSendTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramIconServiceTaskComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramIconServiceTaskComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.position = { x: this.data.x + 4, y: this.data.y + 4 };
        ...
        DiagramIconServiceTaskComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        template: "<raphael-icon-service [position]=\"position\" [stroke]=\"options.stroke\" [strokeWidth]=\"options.strokeWidth\"\n                      [fillColors]=\"options.fillColors\" [fillOpacity]=\"options.fillOpacity\"></raphael-icon-service>"
                    }] }
        ];
        /** @nocollapse */
        DiagramIconServiceTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
    ...
    var DiagramIconSignalComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramIconSignalComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
    ...
    var DiagramIconTimerComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramIconTimerComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramIconUserTaskComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramIconUserTaskComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.position = { x: this.data.x + 4, y: this.data.y + 4 };
        ...
        DiagramIconUserTaskComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        template: "<raphael-icon-user [position]=\"position\" [stroke]=\"options.stroke\" [strokeWidth]=\"options.strokeWidth\"\n                   [fillColors]=\"options.fillColors\" [fillOpacity]=\"options.fillOpacity\"></raphael-icon-user>"
                    }] }
        ];
        /** @nocollapse */
        DiagramIconUserTaskComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramEventSubprocessComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramEventSubprocessComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.rectLeftCorner = { x: this.data.x, y: this.data.y };
        ...
        /** @nocollapse */
        DiagramEventSubprocessComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: DiagramColorService }
            ];
    ...
    var DiagramSubprocessComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiagramSubprocessComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: DiagramColorService }
            ];
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramPoolComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramPoolComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
        ...
        /** @nocollapse */
        DiagramPoolComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
        DiagramPoolComponent.propDecorators = {
            pool: [{ type: core.Input }],
            error: [{ type: core.Output }]
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramPoolsComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramPoolsComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
            };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramLaneComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramLaneComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
        ...
        /** @nocollapse */
        DiagramLaneComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
        DiagramLaneComponent.propDecorators = {
            lane: [{ type: core.Input }],
            error: [{ type: core.Output }]
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DiagramLanesComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        DiagramLanesComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
            };
        ...
        /** @nocollapse */
        DiagramLanesComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
        DiagramLanesComponent.propDecorators = {
            lanes: [{ type: core.Input }],
            error: [{ type: core.Output }]
        };
    ...
    var DiagramTooltipComponent = /** @class */ (function () {
        ...
        DiagramTooltipComponent.propDecorators = {
            tooltipContent: [{ type: core.ViewChild, args: ['tooltipContent',] }],
            data: [{ type: core.Input }],
     ...
     * limitations under the License.
     */
    var RaphaelBase = /** @class */ (function () {
    ...
    var RaphaelCircleDirective = /** @class */ (function (_super) {
        ...
        RaphaelCircleDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-circle, raphael-circle' },] }
        ];
        /** @nocollapse */
        RaphaelCircleDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
     ...
     * Directive selectors without adf- prefix will be deprecated on 3.0.0
     */
    var RaphaelCrossDirective = /** @class */ (function (_super) {
         ...
         * @return {?}
         */
        RaphaelCrossDirective.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                /** @type {?} */
         ...
         * @return {?}
         */
        RaphaelCrossDirective.prototype.draw = /**
         * @param {?} center
         * @param {?} width
         * @param {?} height
         * @param {?=} opts
        ...
        RaphaelCrossDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-cross, raphael-cross' },] }
        ];
        /** @nocollapse */
        RaphaelCrossDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
     ...
     */
    /* tslint:disable */
    var /* tslint:disable */ Polyline = /** @class */ (function () {
    ...
    var RaphaelFlowArrowDirective = /** @class */ (function (_super) {
        ...
        RaphaelFlowArrowDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-flow-arrow, raphael-flow-arrow' },] }
        ];
        /** @nocollapse */
        RaphaelFlowArrowDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
    ...
    var RaphaelMultilineTextDirective = /** @class */ (function (_super) {
        ...
        RaphaelMultilineTextDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-multiline-text, raphael-multiline-text' },] }
        ];
        /** @nocollapse */
        RaphaelMultilineTextDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
    ...
    var RaphaelPentagonDirective = /** @class */ (function (_super) {
        ...
        RaphaelPentagonDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-pentagon, raphael-pentagon' },] }
        ];
        /** @nocollapse */
        RaphaelPentagonDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
        ...
        RaphaelPentagonDirective.propDecorators = {
            ...
            strokeWidth: [{ type: core.Input }],
            fillOpacity: [{ type: core.Input }],
            strokeLinejoin: [{ type: core.Input }],
            error: [{ type: core.Output }]
        };
    ...
    var RaphaelPlusDirective = /** @class */ (function (_super) {
        ...
        RaphaelPlusDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-plus, raphael-plus' },] }
        ];
        /** @nocollapse */
        RaphaelPlusDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
    ...
    var RaphaelRectDirective = /** @class */ (function (_super) {
        ...
        RaphaelRectDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-rect, raphael-rect' },] }
        ];
        /** @nocollapse */
        RaphaelRectDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
    ...
    var RaphaelRhombusDirective = /** @class */ (function (_super) {
        ...
        RaphaelRhombusDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-rhombus, raphael-rhombus' },] }
        ];
        /** @nocollapse */
        RaphaelRhombusDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
    ...
    var RaphaelTextDirective = /** @class */ (function (_super) {
        ...
        RaphaelTextDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-text, raphael-text' },] }
        ];
        /** @nocollapse */
        RaphaelTextDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
     ...
     * Directive selectors without adf- prefix will be deprecated on 3.0.0
     */
    var RaphaelIconAlfrescoPublishDirective = /** @class */ (function (_super) {
         ...
         * @return {?}
         */
        RaphaelIconAlfrescoPublishDirective.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
         ...
         * @return {?}
         */
        RaphaelIconAlfrescoPublishDirective.prototype.draw = /**
         * @param {?} position
         * @return {?}
         */
            function (position) {
        ...
        RaphaelIconAlfrescoPublishDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-icon-alfresco-publish, raphael-icon-alfresco-publish' },] }
        ];
        /** @nocollapse */
        RaphaelIconAlfrescoPublishDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
     ...
     * Directive selectors without adf- prefix will be deprecated on 3.0.0
     */
    var RaphaelIconBoxPublishDirective = /** @class */ (function (_super) {
         ...
         * @return {?}
         */
        RaphaelIconBoxPublishDirective.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.draw(this.position);
         ...
         * @return {?}
         */
        RaphaelIconBoxPublishDirective.prototype.draw = /**
         * @param {?} position
         * @return {?}
         */
            function (position) {
        ...
        RaphaelIconBoxPublishDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-icon-box-publish, raphael-icon-box-publish' },] }
        ];
        /** @nocollapse */
        RaphaelIconBoxPublishDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
    ...
    var RaphaelIconBusinessRuleDirective = /** @class */ (function (_super) {
        ...
        RaphaelIconBusinessRuleDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-icon-business-rule, raphael-icon-business-rule' },] }
        ];
        /** @nocollapse */
        RaphaelIconBusinessRuleDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
     ...
     * Directive selectors without adf- prefix will be deprecated on 3.0.0
     */
    var RaphaelIconCamelDirective = /** @class */ (function (_super) {
         ...
         * @return {?}
         */
        RaphaelIconCamelDirective.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.draw(this.position);
         ...
         * @return {?}
         */
        RaphaelIconCamelDirective.prototype.draw = /**
         * @param {?} position
         * @return {?}
         */
            function (position) {
        ...
        RaphaelIconCamelDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-icon-camel, raphael-icon-camel' },] }
        ];
        /** @nocollapse */
        RaphaelIconCamelDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
     ...
     * Directive selectors without adf- prefix will be deprecated on 3.0.0
     */
    var RaphaelIconErrorDirective = /** @class */ (function (_super) {
         ...
         * @return {?}
         */
        RaphaelIconErrorDirective.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.draw(this.position);
         ...
         * @return {?}
         */
        RaphaelIconErrorDirective.prototype.draw = /**
         * @param {?} position
         * @return {?}
         */
            function (position) {
        ...
        RaphaelIconErrorDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-icon-error, raphael-icon-error' },] }
        ];
        /** @nocollapse */
        RaphaelIconErrorDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
     ...
     * Directive selectors without adf- prefix will be deprecated on 3.0.0
     */
    var RaphaelIconGoogleDrivePublishDirective = /** @class */ (function (_super) {
         ...
         * @return {?}
         */
        RaphaelIconGoogleDrivePublishDirective.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.draw(this.position);
         ...
         * @return {?}
         */
        RaphaelIconGoogleDrivePublishDirective.prototype.draw = /**
         * @param {?} position
         * @return {?}
         */
            function (position) {
        ...
        RaphaelIconGoogleDrivePublishDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-icon-google-drive-publish, raphael-icon-google-drive-publish' },] }
        ];
        /** @nocollapse */
        RaphaelIconGoogleDrivePublishDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
     ...
     * Directive selectors without adf- prefix will be deprecated on 3.0.0
     */
    var RaphaelIconManualDirective = /** @class */ (function (_super) {
         ...
         * @return {?}
         */
        RaphaelIconManualDirective.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.draw(this.position);
         ...
         * @return {?}
         */
        RaphaelIconManualDirective.prototype.draw = /**
         * @param {?} position
         * @return {?}
         */
            function (position) {
        ...
        RaphaelIconManualDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-icon-manual, raphael-icon-manual' },] }
        ];
        /** @nocollapse */
        RaphaelIconManualDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
     ...
     * Directive selectors without adf- prefix will be deprecated on 3.0.0
     */
    var RaphaelIconMessageDirective = /** @class */ (function (_super) {
         ...
         * @return {?}
         */
        RaphaelIconMessageDirective.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.draw(this.position);
         ...
         * @return {?}
         */
        RaphaelIconMessageDirective.prototype.draw = /**
         * @param {?} position
         * @return {?}
         */
            function (position) {
        ...
        RaphaelIconMessageDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-icon-message, raphael-icon-message' },] }
        ];
        /** @nocollapse */
        RaphaelIconMessageDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
    ...
    var RaphaelIconMuleDirective = /** @class */ (function (_super) {
        ...
        RaphaelIconMuleDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-icon-mule, raphael-icon-mule' },] }
        ];
        /** @nocollapse */
        RaphaelIconMuleDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
     ...
     * Directive selectors without adf- prefix will be deprecated on 3.0.0
     */
    var RaphaelIconReceiveDirective = /** @class */ (function (_super) {
         ...
         * @return {?}
         */
        RaphaelIconReceiveDirective.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.draw(this.position);
         ...
         * @return {?}
         */
        RaphaelIconReceiveDirective.prototype.draw = /**
         * @param {?} position
         * @return {?}
         */
            function (position) {
        ...
        RaphaelIconReceiveDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-icon-receive, raphael-icon-receive' },] }
        ];
        /** @nocollapse */
        RaphaelIconReceiveDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
    ...
    var RaphaelIconRestCallDirective = /** @class */ (function (_super) {
        ...
        RaphaelIconRestCallDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-icon-rest-call, raphael-icon-rest-call' },] }
        ];
        /** @nocollapse */
        RaphaelIconRestCallDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
    ...
    var RaphaelIconScriptDirective = /** @class */ (function (_super) {
        ...
        RaphaelIconScriptDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-icon-script, raphael-icon-script' },] }
        ];
        /** @nocollapse */
        RaphaelIconScriptDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
     ...
     * Directive selectors without adf- prefix will be deprecated on 3.0.0
     */
    var RaphaelIconSendDirective = /** @class */ (function (_super) {
         ...
         * @return {?}
         */
        RaphaelIconSendDirective.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.draw(this.position);
         ...
         * @return {?}
         */
        RaphaelIconSendDirective.prototype.draw = /**
         * @param {?} position
         * @return {?}
         */
            function (position) {
        ...
        RaphaelIconSendDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-icon-send, raphael-icon-send' },] }
        ];
        /** @nocollapse */
        RaphaelIconSendDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
    ...
    var RaphaelIconServiceDirective = /** @class */ (function (_super) {
        ...
        RaphaelIconServiceDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-icon-service, raphael-icon-service' },] }
        ];
        /** @nocollapse */
        RaphaelIconServiceDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
    ...
    var RaphaelIconSignalDirective = /** @class */ (function (_super) {
        ...
        RaphaelIconSignalDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-icon-signal, raphael-icon-signal' },] }
        ];
        /** @nocollapse */
        RaphaelIconSignalDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
    ...
    var RaphaelIconTimerDirective = /** @class */ (function (_super) {
        ...
        RaphaelIconTimerDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-icon-timer, raphael-icon-timer' },] }
        ];
        /** @nocollapse */
        RaphaelIconTimerDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
     ...
     * Directive selectors without adf- prefix will be deprecated on 3.0.0
     */
    var RaphaelIconUserDirective = /** @class */ (function (_super) {
         ...
         * @return {?}
         */
        RaphaelIconUserDirective.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.draw(this.position);
         ...
         * @return {?}
         */
        RaphaelIconUserDirective.prototype.draw = /**
         * @param {?} position
         * @return {?}
         */
            function (position) {
        ...
        RaphaelIconUserDirective.decorators = [
            { type: core.Directive, args: [{ selector: 'adf-raphael-icon-user, raphael-icon-user' },] }
        ];
        /** @nocollapse */
        RaphaelIconUserDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: RaphaelService }
            ];
    ...
    var MaterialModule = /** @class */ (function () {
        ...
        MaterialModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        exports: modules(),
                        providers: [
                            { provide: material.MAT_LABEL_GLOBAL_OPTIONS, useValue: ɵ0 }
                        ]
                    },] }
        ];
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var AnalyticsReportHeatMapComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        AnalyticsReportHeatMapComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                var _this = this;
         ...
         * @return {?}
         */
        AnalyticsReportHeatMapComponent.prototype.onMetricChanges = /**
         * @param {?} field
         * @return {?}
         */
            function (field) {
         ...
         * @return {?}
         */
        AnalyticsReportHeatMapComponent.prototype.initForm = /**
         * @return {?}
         */
            function () {
                this.metricForm = this.formBuilder.group({
                    metricGroup: new forms.FormGroup({
                        metric: new forms.FormControl()
                    })
                });
            };
        /**
         * @return {?}
         */
        AnalyticsReportHeatMapComponent.prototype.hasMetric = /**
         * @return {?}
         */
            function () {
        ...
        /** @nocollapse */
        AnalyticsReportHeatMapComponent.ctorParameters = function () {
            return [
                { type: AnalyticsService },
                { type: forms.FormBuilder }
            ];
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var CheckboxWidgetAnalyticsComponent = /** @class */ (function (_super) {
        __extends(CheckboxWidgetAnalyticsComponent, _super);
        function CheckboxWidgetAnalyticsComponent(elementRef) {
        ...
        /** @nocollapse */
        CheckboxWidgetAnalyticsComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
        CheckboxWidgetAnalyticsComponent.propDecorators = {
            ...
            controllerName: [{ type: core.Input, args: ['controllerName',] }]
        };
        return CheckboxWidgetAnalyticsComponent;
    }(WidgetComponent));
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var ɵ0$1 = adfCore.MOMENT_DATE_FORMATS;
    var DateRangeWidgetComponent = /** @class */ (function () {
         ...
         */
            function () {
                var _this = this;
                this.userPreferencesService.select(adfCore.UserPreferenceValues.Locale).subscribe(( /**
                 * @param {?} locale
                 * @return {?}
                 */function (locale) {
                ...
                /** @type {?} */
                var startDateControl = new forms.FormControl(this.startDatePicker);
                startDateControl.setValidators(forms.Validators.required);
                this.dateRange.addControl('startDate', startDateControl);
                /** @type {?} */
                var endDateControl = new forms.FormControl(this.endDatePicker);
                endDateControl.setValidators(forms.Validators.required);
        ...
        DateRangeWidgetComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [
                            { provide: material.DateAdapter, useClass: adfCore.MomentDateAdapter },
        ...
        /** @nocollapse */
        DateRangeWidgetComponent.ctorParameters = function () {
            return [
        ...
        DateRangeWidgetComponent.propDecorators = {
            dateRange: [{ type: core.Input, args: ['group',] }],
            field: [{ type: core.Input }],
    ...
    var DropdownWidgetAnalyticsComponent = /** @class */ (function (_super) {
        __extends(DropdownWidgetAnalyticsComponent, _super);
         ...
         */
            function () {
                if (this.required) {
                    this.formGroup.get(this.controllerName).setValidators(forms.Validators.compose(this.buildValidatorList()));
                }
            };
        /**
         * @param {?} controller
        ...
        DropdownWidgetAnalyticsComponent.propDecorators = {
            ...
            controllerName: [{ type: core.Input, args: ['controllerName',] }],
            fieldChanged: [{ type: core.Output }],
            showDefaultOption: [{ type: core.Input }],
            required: [{ type: core.Input }],
            defaultOptionText: [{ type: core.Input }]
        };
    ...
    var NumberWidgetAnalyticsComponent = /** @class */ (function (_super) {
        __extends(NumberWidgetAnalyticsComponent, _super);
         ...
         */
            function () {
                if (this.required) {
                    this.formGroup.get(this.controllerName).setValidators(forms.Validators.required);
                }
            };
        ...
        /** @nocollapse */
        NumberWidgetAnalyticsComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
    ...
    var DurationWidgetComponent = /** @class */ (function (_super) {
         ...
         */
            function () {
                /** @type {?} */
                var timeType = new forms.FormControl();
        ...
        /** @nocollapse */
        DurationWidgetComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var AnalyticsProcessModule = /** @class */ (function () {
        function AnalyticsProcessModule() {
        }
    ...
    exports.AnalyticsProcessModule = AnalyticsProcessModule;
    ...
    exports.InsightsModuleLazy = InsightsModuleLazy;
    exports.ɵdd = AnalyticsReportHeatMapComponent;
    exports.ɵdi = CheckboxWidgetAnalyticsComponent;
    exports.ɵdj = DateRangeWidgetComponent;
    exports.ɵde = DropdownWidgetAnalyticsComponent;
    exports.ɵdh = DurationWidgetComponent;
    exports.ɵdg = NumberWidgetAnalyticsComponent;
    exports.ɵdf = WidgetComponent;
    exports.ɵm = DiagramAlfrescoPublishTaskComponent;
    exports.ɵp = DiagramBoxPublishTaskComponent;
    exports.ɵs = DiagramBusinessRuleTaskComponent;
    exports.ɵk = DiagramCamelTaskComponent;
    exports.ɵe = DiagramContainerServiceTaskComponent;
    exports.ɵo = DiagramGoogleDrivePublishTaskComponent;
    exports.ɵj = DiagramManualTaskComponent;
    exports.ɵl = DiagramMuleTaskComponent;
    exports.ɵq = DiagramReceiveTaskComponent;
    exports.ɵn = DiagramRestCallTaskComponent;
    exports.ɵr = DiagramScriptTaskComponent;
    exports.ɵh = DiagramSendTaskComponent;
    exports.ɵg = DiagramServiceTaskComponent;
    exports.ɵf = DiagramTaskComponent;
    exports.ɵi = DiagramUserTaskComponent;
    exports.ɵbq = DiagramBoundaryEventComponent;
    exports.ɵbr = DiagramThrowEventComponent;
    exports.ɵd = DiagramEndEventComponent;
    exports.ɵb = DiagramEventComponent;
    exports.ɵc = DiagramStartEventComponent;
    exports.ɵx = DiagramEventGatewayComponent;
    exports.ɵu = DiagramExclusiveGatewayComponent;
    exports.ɵt = DiagramGatewayComponent;
    exports.ɵv = DiagramInclusiveGatewayComponent;
    exports.ɵw = DiagramParallelGatewayComponent;
    exports.ɵbl = DiagramContainerIconEventTaskComponent;
    exports.ɵbe = DiagramIconAlfrescoPublishTaskComponent;
    exports.ɵbh = DiagramIconBoxPublishTaskComponent;
    exports.ɵbk = DiagramIconBusinessRuleTaskComponent;
    exports.ɵbc = DiagramIconCamelTaskComponent;
    exports.ɵbn = DiagramIconErrorComponent;
    exports.ɵbg = DiagramIconGoogleDrivePublishTaskComponent;
    exports.ɵbb = DiagramIconManualTaskComponent;
    exports.ɵbp = DiagramIconMessageComponent;
    exports.ɵbd = DiagramIconMuleTaskComponent;
    exports.ɵbi = DiagramIconReceiveTaskComponent;
    exports.ɵbf = DiagramIconRestCallTaskComponent;
    exports.ɵbj = DiagramIconScriptTaskComponent;
    exports.ɵz = DiagramIconSendTaskComponent;
    exports.ɵy = DiagramIconServiceTaskComponent;
    exports.ɵbo = DiagramIconSignalComponent;
    exports.ɵbm = DiagramIconTimerComponent;
    exports.ɵba = DiagramIconUserTaskComponent;
    exports.ɵbs = DiagramIntermediateCatchingEventComponent;
    exports.ɵcq = RaphaelIconAlfrescoPublishDirective;
    exports.ɵct = RaphaelIconBoxPublishDirective;
    exports.ɵcw = RaphaelIconBusinessRuleDirective;
    exports.ɵco = RaphaelIconCamelDirective;
    exports.ɵcy = RaphaelIconErrorDirective;
    exports.ɵcs = RaphaelIconGoogleDrivePublishDirective;
    exports.ɵcn = RaphaelIconManualDirective;
    exports.ɵda = RaphaelIconMessageDirective;
    exports.ɵcp = RaphaelIconMuleDirective;
    exports.ɵcu = RaphaelIconReceiveDirective;
    exports.ɵcr = RaphaelIconRestCallDirective;
    exports.ɵcv = RaphaelIconScriptDirective;
    exports.ɵcl = RaphaelIconSendDirective;
    exports.ɵck = RaphaelIconServiceDirective;
    exports.ɵcz = RaphaelIconSignalDirective;
    exports.ɵcx = RaphaelIconTimerDirective;
    exports.ɵcm = RaphaelIconUserDirective;
    exports.ɵcb = RaphaelBase;
    exports.ɵca = RaphaelCircleDirective;
    exports.ɵcg = RaphaelCrossDirective;
    exports.ɵcf = RaphaelFlowArrowDirective;
    exports.ɵce = RaphaelMultilineTextDirective;
    exports.ɵcj = RaphaelPentagonDirective;
    exports.ɵch = RaphaelPlusDirective;
    exports.ɵcc = RaphaelRectDirective;
    exports.ɵci = RaphaelRhombusDirective;
    exports.ɵcd = RaphaelTextDirective;
    exports.ɵa = RaphaelService;
    exports.ɵbu = DiagramEventSubprocessComponent;
    exports.ɵbt = DiagramSubprocessComponent;
    exports.ɵby = DiagramLaneComponent;
    exports.ɵbx = DiagramLanesComponent;
    exports.ɵbw = DiagramPoolComponent;
    exports.ɵbv = DiagramPoolsComponent;
    exports.ɵbz = DiagramTooltipComponent;
    exports.ɵdc = MaterialModule;
    exports.ɵdb = modules;
...
//# sourceMappingURL=adf-insights.umd.js.map