...
export declare class AlfrescoApiClient {
    storage: Storage;
    host: string;
    className: string;
    ...
    progress(event: any, eventEmitter: _Emitter): void;
    /**
    ...
    buildRequest(httpMethod: string, url: string, queryParams: any, headerParams: any, formParams: any, bodyParam: any, contentTypes: any, accepts: any, responseType: any, eventEmitter: _Emitter, returnType: any): any;
