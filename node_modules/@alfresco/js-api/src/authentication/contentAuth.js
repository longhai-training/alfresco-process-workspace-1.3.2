...
class ContentAuth extends alfrescoApiClient_1.AlfrescoApiClient {
    constructor(config, alfrescoApi) {
        super();
        this.className = 'ContentAuth';
        this.setConfig(config);
        this.authApi = new authentication_api_1.AuthenticationApi(alfrescoApi);
        Emitter.call(this);
    }
    setConfig(config) {
        this.config = config;
...
ContentAuth.authentications = new authentication_1.Authentication({
    'basicAuth': { ticket: '' }, type: 'basic'
});
exports.ContentAuth = ContentAuth;
Emitter(ContentAuth.prototype);
