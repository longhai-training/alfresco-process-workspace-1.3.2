...
class Oauth2Auth extends alfrescoApiClient_1.AlfrescoApiClient {
    constructor(config) {
        super();
        this.authentications = new authentication_1.Authentication({
    ...
    discoveryUrls() {
        return new Promise((resolve, reject) => {
            ...
            if (!this.discovery) {
                ...
                this.callApi(url, 'GET', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts).then((discovery) => {
                    this.discovery = {};
        ...
        return new Promise((resolve, reject) => {
            ...
            if (this.discovery.jwksUri) {
                if (!this.jwks) {
                    ...
                    let contentTypes = ['application/json'];
                    let accepts = ['application/json'];
                    this.callCustomApi(this.discovery.jwksUri, 'GET', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts).then((jwks) => {
                        this.jwks = jwks;
                        this.emit('jwks', jwks);
    ...
    checkFragment(externalHash) {
        return new Promise((resolve, reject) => {
            ...
            if (this.hashFragmentParams) {
                ...
                this.processJWTToken(idToken).then((jwt) => {
                    if (jwt) {
