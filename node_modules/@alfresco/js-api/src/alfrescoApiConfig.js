...
const oauth2Config_1 = require("./authentication/oauth2Config");
class AlfrescoApiConfig {
    constructor(input) {
        ...
        this.oauth2 = input.oauth2 ? new oauth2Config_1.Oauth2Config(input.oauth2) : undefined;
    }
}
exports.AlfrescoApiConfig = AlfrescoApiConfig;
//# sourceMappingURL=alfrescoApiConfig.js.map