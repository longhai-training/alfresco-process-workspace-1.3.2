...
const personEntry_1 = require("../model/personEntry");
const personPaging_1 = require("../model/personPaging");
const base_api_1 = require("./base.api");
class PeopleApi extends base_api_1.BaseApi {
    createPerson(personBodyCreate, opts) {
        ...
        return this.apiClient.callApi('/people', 'POST', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, personEntry_1.PersonEntry);
    }
    ...
    getPerson(personId, opts) {
        ...
        let contentTypes = ['application/json'];
        let accepts = ['application/json'];
        return this.apiClient.callApi('/people/{personId}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, personEntry_1.PersonEntry);
    }
    listPeople(opts) {
        opts = opts || {};
        let postBody = null;
        ...
        let contentTypes = ['application/json'];
        let accepts = ['application/json'];
        return this.apiClient.callApi('/people', 'GET', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, personPaging_1.PersonPaging);
    }
    ...
    updatePerson(personId, personBodyUpdate, opts) {
        ...
        let contentTypes = ['application/json'];
        let accepts = ['application/json'];
        return this.apiClient.callApi('/people/{personId}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, personEntry_1.PersonEntry);
    }
}
