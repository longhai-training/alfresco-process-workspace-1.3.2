...
const rMSiteEntry_1 = require("../model/rMSiteEntry");
const base_api_1 = require("./base.api");
class GsSitesApi extends base_api_1.BaseApi {
    createRMSite(siteBodyCreate, opts) {
        ...
        return this.apiClient.callApi('/gs-sites', 'POST', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, rMSiteEntry_1.RMSiteEntry);
    }
    deleteRMSite() {
        let postBody = null;
        let pathParams = {};
    ...
    getRMSite(opts) {
        ...
        let contentTypes = ['application/json'];
        let accepts = ['application/json'];
        return this.apiClient.callApi('/gs-sites/rm', 'GET', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, rMSiteEntry_1.RMSiteEntry);
    }
    updateRMSite(siteBodyUpdate, opts) {
        ...
        let contentTypes = ['application/json'];
        let accepts = ['application/json'];
        return this.apiClient.callApi('/gs-sites/rm', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, rMSiteEntry_1.RMSiteEntry);
    }
}
