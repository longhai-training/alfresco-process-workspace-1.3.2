...
const syncLogEntryRepresentation_1 = require("../model/syncLogEntryRepresentation");
const base_api_1 = require("./base.api");
class IDMSyncApi extends base_api_1.BaseApi {
    ...
    getSyncLogEntries(opts) {
        ...
        let contentTypes = ['application/json'];
        let accepts = ['application/json'];
        return this.apiClient.callApi('/api/enterprise/idm-sync-log-entries', 'GET', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, syncLogEntryRepresentation_1.SyncLogEntryRepresentation);
    }
}
