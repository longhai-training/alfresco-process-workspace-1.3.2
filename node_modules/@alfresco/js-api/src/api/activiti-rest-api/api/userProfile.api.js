...
class UserProfileApi extends base_api_1.BaseApi {
    ...
    getProfile() {
        ...
        let contentTypes = ['application/json'];
        let accepts = ['application/json'];
        return this.apiClient.callApi('/api/enterprise/profile', 'GET', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, userRepresentation_1.UserRepresentation);
    }
    updateProfile(userRepresentation) {
        ...
        let contentTypes = ['application/json'];
        let accepts = ['application/json'];
        return this.apiClient.callApi('/api/enterprise/profile', 'POST', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, userRepresentation_1.UserRepresentation);
    }
    uploadProfilePicture(file) {
        ...
        let accepts = ['application/json'];
        return this.apiClient.callApi('/api/enterprise/profile-picture', 'POST', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, imageUploadRepresentation_1.ImageUploadRepresentation);
    }
}
