...
class TaskActionsApi extends base_api_1.BaseApi {
    assignTask(taskId, userIdentifier) {
        ...
        return this.apiClient.callApi('/api/enterprise/tasks/{taskId}/action/assign', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, taskRepresentation_1.TaskRepresentation);
    }
