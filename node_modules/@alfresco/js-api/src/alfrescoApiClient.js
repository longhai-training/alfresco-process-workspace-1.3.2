...
const superagent_ = require("superagent");
...
class AlfrescoApiClient {
    ...
    applyAuthToRequest(request) {
        if (this.authentications) {
            switch (this.authentications.type) {
                case 'basic':
                    let basicAuth = this.authentications.basicAuth;
    ...
    callApi(path, httpMethod, pathParams, queryParams, headerParams, formParams, bodyParam, contentTypes, accepts, returnType, contextRoot, responseType) {
        let url;
        if (contextRoot) {
