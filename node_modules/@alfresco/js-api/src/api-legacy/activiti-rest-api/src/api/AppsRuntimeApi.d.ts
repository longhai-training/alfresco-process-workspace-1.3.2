 ...
 * @deprecated 3.0.0
 */
export declare class AppsRuntimeApi {
    ...
    getAppDefinitions(): Promise<import("api/activiti-rest-api/model/resultListDataRepresentationAppDefinitionRepresentation").ResultListDataRepresentationAppDefinitionRepresentation>;
}
