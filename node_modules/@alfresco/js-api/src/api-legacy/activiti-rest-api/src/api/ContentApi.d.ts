...
export declare class ContentApi {
    ...
    getContentPreview(contentId: any): Promise<any>;
    /**
    ...
    getRelatedContentForProcessInstance(processInstanceId: string, isRelated: any): Promise<import("api/activiti-rest-api/model/resultListDataRepresentationRelatedContentRepresentation").ResultListDataRepresentationRelatedContentRepresentation>;
    getRelatedContentForTask(taskId: string, isRelated: any): Promise<import("api/activiti-rest-api/model/resultListDataRepresentationRelatedContentRepresentation").ResultListDataRepresentationRelatedContentRepresentation>;
}
