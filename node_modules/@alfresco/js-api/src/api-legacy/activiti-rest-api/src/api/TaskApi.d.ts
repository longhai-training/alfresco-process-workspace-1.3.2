...
export declare class TaskApi {
    ...
    getTaskAuditJson(taskId: any): Promise<TaskAuditInfoRepresentation>;
    getTaskAuditPdf(taskId: any): Promise<TaskAuditInfoRepresentation>;
    getRelatedContentForTask(taskId: string, opts?: any): Promise<ResultListDataRepresentationRelatedContentRepresentation>;
    getRestFieldValuesColumn(taskId: any, field: any, column: any): Promise<any>;
    getRestFieldValues(taskId: any, field: any): Promise<import("api/activiti-rest-api/model/formValueRepresentation").FormValueRepresentation[]>;
