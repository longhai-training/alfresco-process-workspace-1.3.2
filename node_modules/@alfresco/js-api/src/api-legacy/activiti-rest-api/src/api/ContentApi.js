...
const content_api_1 = require("../../../../api/activiti-rest-api/api/content.api");
const processInstances_api_1 = require("../../../../api/activiti-rest-api/api/processInstances.api");
class ContentApi {
    init(alfrescoApi) {
        this.contentApi = new content_api_1.ContentApi(alfrescoApi);
        this.processInstancesApi = new processInstances_api_1.ProcessInstancesApi(alfrescoApi);
    }
    createRelatedContentOnProcessInstancePostBody(processInstanceId, relatedContent, opts) {
        return this.contentApi.createRelatedContentOnProcessInstance(processInstanceId, relatedContent, opts);
    }
    createRelatedContentOnProcessInstance(processInstanceId, file, opts) {
        return this.contentApi.createRelatedContentOnProcessInstance(processInstanceId, file, opts);
    }
    createRelatedContentOnTaskPostBody(taskId, relatedContent, opts) {
        return this.contentApi.createRelatedContentOnTask(taskId, relatedContent, opts);
    }
    createRelatedContentOnTask(taskId, file, opts) {
