...
export declare class ProcessApi {
    ...
    getProcessAuditJson(processInstanceId: any): Promise<ProcessInstanceAuditInfoRepresentation>;
    getProcessAuditPdf(processInstanceId: any): Promise<any>;
