...
const nodes_api_1 = require("../../../../api/content-rest-api/api/nodes.api");
const sharedlinks_api_1 = require("../../../../api/content-rest-api/api/sharedlinks.api");
const renditions_api_1 = require("../../../../api/content-rest-api/api/renditions.api");
const sites_api_1 = require("../../../../api/content-rest-api/api/sites.api");
const trashcan_api_1 = require("../../../../api/content-rest-api/api/trashcan.api");
class ChangesApi {
    init(alfrescoApi) {
        this.nodesApi = new nodes_api_1.NodesApi(alfrescoApi);
        this.sharedlinksApi = new sharedlinks_api_1.SharedlinksApi(alfrescoApi);
        this.renditionsApi = new renditions_api_1.RenditionsApi(alfrescoApi);
        this.sitesApi = new sites_api_1.SitesApi(alfrescoApi);
        this.trashcanApi = new trashcan_api_1.TrashcanApi(alfrescoApi);
    }
...
//# sourceMappingURL=changesApi.js.map